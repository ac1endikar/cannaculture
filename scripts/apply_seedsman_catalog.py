...
from fetch_seedsman_catalog import SEEDSMAN_CATALOG
...
for s_strain in SEEDSMAN_CATALOG:
    ...
    print(f"✅ Embedded Seedsman strain: {s_id} ({s_obj['name']})")

print(f"Total strains after Seedsman integration: {len(strains_map)}")
...
print(f"✅ Saved Seedsman database to data.js ({len(final_code):,} bytes)")
