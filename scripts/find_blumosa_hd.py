...
queries = [
    "Blumosa TH Seeds bud flower cannabis",
    "TH Seeds Blumosa strain grow room harvest",
    "Blumosa strain GrowDiaries bud",
    "Blumosa TH Seeds flower trichomes"
]
    ...
    try:
        ...
        if len(data) > 15000:
            ...
            if im.width >= 500 and im.height >= 500:
                out_path = f'd:/cannaculture/img/ths-blumosa-real{i}.jpg'
