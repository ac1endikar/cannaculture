...
targets = [
    ("dank-dough", "Dank Dough Archive Seed Bank strain product bud flower", "arc-dank-dough"),
    ("double-cross", "Double Cross Archive Seed Bank strain product bud flower", "arc-double-cross")
]
