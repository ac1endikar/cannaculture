...
queries = [
    "Dame Blanche The Flying Dutchmen strain product flower",
    "Dame Blanche strain grow room harvest bud",
    "Dame Blanche Flying Dutchmen seed bank flower",
    "Dame Blanche White Widow Skunk strain bud"
]
    ...
    try:
        ...
        if len(data) > 15000:
            ...
            if im.width >= 400 and im.height >= 400:
                out_path = f'd:/cannaculture/img/tfd-dame-blanche-new{i}.jpg'
