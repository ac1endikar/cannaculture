...
targets = [
    ("afghani-1", "Afghani 1 White Label Seed Co strain bud flower harvest", "wls-afghani-1"),
    ("master-kush", "Master Kush White Label Seed Co strain bud flower harvest", "wls-master-kush")
]
