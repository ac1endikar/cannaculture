...
targets = [
    ("blue-dream", "Blue Dream Humboldt Seed Organization strain flower bud", "hso-blue-dream"),
    ("sapphire-og", "Sapphire OG Humboldt Seed Organization strain flower bud", "hso-sapphire-og")
]
