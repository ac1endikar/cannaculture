...
queries = [
    ("707-headband", "707 Headband strain dry bud product flower"),
    ("707-headband", "707 Headband Humboldt Seed Organization strain nug"),
    ("707-headband", "707 Headband seed bank product flower photo"),
    ("blue-fire", "Blue Fire Humboldt Seed Organization strain bud harvest"),
    ("blue-fire", "Blue Fire strain dry bud product flower photo"),
    ("blue-fire", "Blue Fire Humboldt seeds product flower photo")
]
...
for prefix, q in queries:
    ...
    try:
        ...
        for i, img_url in enumerate(valid[:6]):
            try:
                ...
                if len(data) > 15000:
                    ...
                    if im.width >= 400 and im.height >= 400:
                        out_path = f"{out_dir}/{prefix}-hd{i}_{q[:10].replace(' ','_')}.jpg"
