...
targets = [
    ("liberty-haze", "Liberty Haze strain product bud flower harvest", "hso-liberty-haze"),
    ("707-headband", "707 Headband Humboldt Seed Organization strain flower bud", "hso-707-headband"),
    ("blue-fire", "Blue Fire Humboldt Seed Organization strain flower bud", "hso-blue-fire")
]
