...
// ==========================================
  ...
  // ==========================================
  {
    ...
    indicaPct: 75,
    sativaPct: 25,
    genetics: "Ed Rosenthal Super Bud x Chronic",
    lineage: "Cruce de Ed Rosenthal Super Bud de floración ultra rápida con la legendaria Chronic",
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 45, caryophyllene: 30, limonene: 25 },
    flavors: ["Cítricos Skunk", "Madera Noble", "Incienso Suave", "Frutas Maduras"],
    effects: ["Efecto Contundente", "Relajación Corporal", "Paz Mental", "Bienestar Prolongado"],
    activities: ["relax", "sleep", "movies"],
    description: "Auténtica bestia productiva de Dr. Underground. Combina cosechas colosales con una floración asombrosamente corta. Desprende un aroma complejo a maderas nobles y frutas skunk, proporcionando una relajación demoledora ideal para el descanso nocturno.",
    image: "img/drug-king-kong.webp",
    visualColor: "linear-gradient(135deg, #059669 0%, #064E3B 100%)",
    bgPattern: "radial-gradient(circle, rgba(5,150,105,0.25) 0%, transparent 70%)"
  },
  {
    id: "drug-melon-gum",
    name: "Melon Gum",
    ...
    lineage: "Híbrido extra dulce nacido de la unión entre una deliciosa Bubblegum y una aromática Lavender",
    dominantTerpene: "limonene",
    terpenes: { limonene: 42, myrcene: 32, linalool: 26 },
    flavors: ["Chicle de Melón", "Fresas Silvestres", "Toque Floral", "Lavanda Dulce"],
    effects: ["Euforia Social", "Sonrisa Permanente", "Relajación Festiva", "Cosquilleo Físico"],
    activities: ["social", "music", "party"],
    description: "Una de las variedades más golosas y populares del banco. Destaca por sus tonalidades rojizas y púrpuras con un bouquet inconfundible a golosina de melón y frutos rojos. Su efecto eleva el ánimo al instante manteniendo el cuerpo en un estado de confort inmejorable.",
    image: "img/drug-melon-gum.webp",
    visualColor: "linear-gradient(135deg, #EC4899 0%, #8B5CF6 100%)",
    bgPattern: "radial-gradient(circle, rgba(236,72,153,0.25) 0%, transparent 70%)"
  },
  {
    id: "drug-crystal-meth",
    name: "Crystal M.E.T.H.",
    bank: "Dr. Underground",
    species: "Sativa",
    thc: 22.5,
    cbd: 0.4,
    ...
    indicaPct: 20,
    sativaPct: 80,
    genetics: "Destroyer x Critical Mass",
    lineage: "Combinación electrizante de la pura sativa Destroyer con la rapidez y resina de Critical Mass",
    dominantTerpene: "terpinolene",
    terpenes: { terpinolene: 46, pinene: 30, caryophyllene: 24 },
    flavors: ["Pimienta Negra", "Anís Picante", "Notas Metálicas", "Cítrico Ácido"],
    effects: ["Explosión Cerebral", "Energía Inagotable", "Lucidez Mental", "Euforia Eléctrica"],
    activities: ["creativity", "sports", "focus"],
    description: "Sativa explosiva y demoledora. Su nombre homenajea su asombrosa capa de resina cristalina blanca que cubre cada cáliz. Produce un efecto cerebral intenso, eléctrico y lúcido con aromas penetrantes a especias, pimienta blanca y toques cítricos.",
    image: "img/drug-crystal-meth.webp",
    visualColor: "linear-gradient(135deg, #3B82F6 0%, #1D4ED8 100%)",
    bgPattern: "radial-gradient(circle, rgba(59,130,246,0.25) 0%, transparent 70%)"
  },
  {
    ...
    indicaPct: 75,
    sativaPct: 25,
    genetics: "Sensi Star x White Russian",
    lineage: "Híbrido de alto contenido terapéutico creado a partir de parentales legendarios de resina medicinal",
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 48, caryophyllene: 32, pinene: 20 },
    flavors: ["Tierra Húmeda", "Pino Silvestre", "Cítrico Amargo", "Especias Medicinales"],
    effects: ["Alivio Terapéutico", "Sedación Suave", "Desconexión Total", "Calma Anti-Estrés"],
    activities: ["meditation", "recovery", "sleep"],
    description: "Variedad diseñada especialmente para fines terapéuticos y bienestar corporal. Presenta un equilibrio cannabinoide idóneo con alto CBD que mitiga tensiones musculares y estrés sin saturar la mente. Aroma clásico terroso y a pino fresco con toques balsámicos.",
    image: "img/drug-painkiller.webp",
    visualColor: "linear-gradient(135deg, #10B981 0%, #047857 100%)",
    bgPattern: "radial-gradient(circle, rgba(16,185,129,0.25) 0%, transparent 70%)"
  },
  {
    id: "drug-brooklyn-mango",
    name: "Brooklyn Mango",
    bank: "Dr. Underground",
    species: "Híbrida",
    thc: 21.0,
    ...
    indicaPct: 50,
    sativaPct: 50,
    genetics: "Brooklyn Mango Clone x NYC Diesel",
    lineage: "Cruza tropical entre un clon élite seleccionado de sabor a mango y la contundente NYC Diesel",
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 44, limonene: 34, ocimene: 22 },
    flavors: ["Mango Tropical", "Combustible Diésel", "Fruta de la Pasión", "Cítrico Exótico"],
    effects: ["Subidón Motivador", "Calidez Física", "Estimulación Creativa", "Buen Humor"],
    activities: ["creativity", "cooking", "social"],
    description: "Cruce exótico y aromático que funde el sabor jugoso del mango maduro con el inconfundible fondo diésel neoyorquino. Sus flores son densas, pegajosas y rebosantes de tricomas. Proporciona una experiencia placentera, sociable y creativa.",
    image: "img/drug-brooklyn-mango.webp",
    visualColor: "linear-gradient(135deg, #F59E0B 0%, #D97706 100%)",
    bgPattern: "radial-gradient(circle, rgba(245,158,11,0.25) 0%, transparent 70%)"
  },
  {
    ...
    indicaPct: 60,
    sativaPct: 40,
    genetics: "King Kong x AK-47",
    lineage: "Híbrido brutal que fusiona la descomunal producción de King Kong con la potencia clásica de AK-47",
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 40, myrcene: 35, limonene: 25 },
    flavors: ["Skunk Dulce", "Especias Fuertes", "Pino Resinoso", "Toque Cítrico"],
    effects: ["Potencia Demoledora", "Euforia Mixta", "Pesadez Muscular", "Relajación Duradera"],
    activities: ["relax", "gaming", "couch"],
    description: "Potencia desatada. La velocidad y masiva floración de King Kong se unen al pegue histórico de AK-47. Produce cogollos pesados como piedras con una concentración sobresaliente de resina. Aroma penetrante a skunk especiado con fondo a bosque de pinos.",
    image: "img/drug-kong-47.webp",
    visualColor: "linear-gradient(135deg, #84CC16 0%, #4D7C0F 100%)",
    bgPattern: "radial-gradient(circle, rgba(132,204,22,0.25) 0%, transparent 70%)"
  },
  {
    id: "drug-black-jesus-og",
    name: "Black Jesus OG",
    bank: "Dr. Underground",
    species: "Índica",
    thc: 23.0,
    ...
    indicaPct: 85,
    sativaPct: 15,
    genetics: "Tahoe OG x Soul Star",
    lineage: "Descendiente directa del clon élite Tahoe OG combinado con el vigor y densidad de Soul Star",
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 45, myrcene: 35, limonene: 20 },
    flavors: ["Kush Gaseoso", "Pino Terroso", "Limón Químico", "Madera Quemada"],
    effects: ["Golpe Físico Intenso", "Sedación Plena", "Desaceleración Mental", "Sueño Reparador"],
    activities: ["sleep", "meditation", "recovery"],
    description: "Una de las índicas más oscuras, resinosas y narcóticas del catálogo. Su perfil terpénico destaca por un aroma profundo a combustible kush, limón maduro y pino húmedo. Produce un efecto pesado que desconecta el estrés y acoge el cuerpo con calidez.",
    image: "img/drug-black-jesus-og.webp",
    visualColor: "linear-gradient(135deg, #1E1B4B 0%, #312E81 100%)",
    bgPattern: "radial-gradient(circle, rgba(30,27,75,0.3) 0%, transparent 70%)"
  },
  {
    id: "drug-u-pink-kush",
    name: "U-Pink Kush",
    ...
    indicaPct: 80,
    sativaPct: 20,
    genetics: "Underground Pink Kush",
    lineage: "Selección exclusiva de fenotipos rosados de Kush con densos tricomas y aromas florales densos",
    dominantTerpene: "linalool",
    terpenes: { linalool: 38, caryophyllene: 36, myrcene: 26 },
    flavors: ["Kush Floral", "Vainilla Dulce", "Pétalos de Rosa", "Tierra Especiada"],
    effects: ["Relajación Sedosa", "Paz Interior", "Calma Agradable", "Sensación Aterciopelada"],
    activities: ["relax", "spa", "chill"],
    description: "Fenotipo selecto de belleza hipnótica que adquiere tonos rosados y púrpuras al final de floración. Su perfume evoca un jardín de rosas con matices dulces de vainilla y el fondo clásico terroso de las mejores líneas Kush.",
    image: "img/drug-u-pink-kush.webp",
    visualColor: "linear-gradient(135deg, #F43F5E 0%, #BE123C 100%)",
    bgPattern: "radial-gradient(circle, rgba(244,63,94,0.25) 0%, transparent 70%)"
  },
  {
    ...
    indicaPct: 75,
    sativaPct: 25,
    genetics: "Sensi Star x Peyote Purple",
    lineage: "Cruce de la laureada Sensi Star con una seleccionada Peyote Purple de tonos oscuros y gran potencia",
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 42, caryophyllene: 33, pinene: 25 },
    flavors: ["Frutos Negros", "Hachís Exótico", "Lavanda Metálica", "Tierra Húmeda"],
    effects: ["Efecto Narcótico", "Viaje Meditativo", "Relajación Muscular Profunda", "Serenidad"],
    activities: ["meditation", "listening", "night"],
    description: "Cruce magistral entre dos variedades legendarias de gran reputación medicinal y resina prodigiosa. Regala cálices cargados de cristales y un aroma a hachís afgano con toques de lavanda y moras silvestres.",
    image: "img/drug-soul-star.webp",
    visualColor: "linear-gradient(135deg, #6366F1 0%, #4338CA 100%)",
    bgPattern: "radial-gradient(circle, rgba(99,102,241,0.25) 0%, transparent 70%)"
  },
  {
    id: "drug-american-beauty",
    ...
    indicaPct: 55,
    sativaPct: 45,
    genetics: "Plushberry x King Kong",
    lineage: "Híbrido visualmente espectacular nacido de cruzar Plushberry con el monstruo productor King Kong",
    dominantTerpene: "limonene",
    terpenes: { limonene: 40, myrcene: 35, caryophyllene: 25 },
    flavors: ["Frutos del Bosque", "Cerezas Silvestres", "Mermelada Dulce", "Toque Skunk"],
    effects: ["Euforia Risueña", "Equilibrio Armónico", "Relajación Agradable", "Placer Visual"],
    activities: ["art", "nature", "social"],
    description: "Híbrido de porte deslumbrante y colores vivos que hereda el delicioso sabor a frutas del bosque y mermelada de Plushberry con la rapidez y densidad productiva de King Kong. Su efecto proporciona alegría, balance y relajación placentera.",
    image: "img/drug-american-beauty.webp",
    visualColor: "linear-gradient(135deg, #D946EF 0%, #A21CAF 100%)",
    bgPattern: "radial-gradient(circle, rgba(217,70,239,0.25) 0%, transparent 70%)"
  },

  // ==========================================
  // CROCKETT FAMILY FARMS (10 cepas)
  // ==========================================
  {
    id: "cff-sour-tangie",
    name: "Sour Tangie",
    bank: "Crockett Family Farms",
    species: "Sativa",
    thc: 23.0,
    cbd: 0.3,
    floweringDays: 65,
    ...
    lineage: "La unión maestra del legendario esqueje ECSD con el inconfundible perfil cítrico de Tangie",
    dominantTerpene: "limonene",
    terpenes: { limonene: 48, myrcene: 30, caryophyllene: 22 },
    flavors: ["Mandarina Madura", "Combustible Diésel", "Cítrico Punzante", "Piel de Naranja"],
    effects: ["Energía Eléctrica", "Euforia Inspiradora", "Claridad Mental", "Motivación Pura"],
    activities: ["creativity", "outdoor", "social"],
    description: "Una de las creaciones más aclamadas a nivel global en la historia moderna del cannabis. Fusiona el combustible penetrante de la East Coast Sour Diesel con el néctar de mandarina fresca de Tangie. Proporciona un subidón motivador, expansivo y lleno de inspiración.",
    image: "img/cff-sour-tangie.webp",
    visualColor: "linear-gradient(135deg, #F97316 0%, #C2410C 100%)",
    bgPattern: "radial-gradient(circle, rgba(249,115,22,0.25) 0%, transparent 70%)"
  },
  {
    id: "cff-clementine",
    name: "Clementine",
    ...
    lineage: "Ganadora de copas creada al cruzar Tangie con la aromática Lemon Skunk de Crockett",
    dominantTerpene: "terpinolene",
    terpenes: { terpinolene: 44, limonene: 36, pinene: 20 },
    flavors: ["Zumo de Clementina", "Limón Dulce", "Hierbas Frescas", "Naranja Azucarada"],
    effects: ["Optimismo Radiante", "Subidón Chispeante", "Vitalidad Desbordante", "Buen Humor"],
    activities: ["music", "social", "sports"],
    description: "Campeona en múltiples Cannabis Cups por su inigualable bouquet cítrico a clementina recién exprimida con notas dulces de limón. Despierta una oleada instantánea de energía positiva, entusiasmo y lucidez ideal para arrancar el día con alegría.",
    image: "img/cff-clementine.webp",
    visualColor: "linear-gradient(135deg, #FBBF24 0%, #D97706 100%)",
    bgPattern: "radial-gradient(circle, rgba(251,191,36,0.25) 0%, transparent 70%)"
  },
  {
    id: "cff-banana-split",
    name: "Banana Split",
    ...
    lineage: "Postre cannábico que combina el bouquet de mandarina de Tangie con la cremosidad de Banana Sherbet",
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 42, limonene: 34, caryophyllene: 24 },
    flavors: ["Plátano Maduro", "Crema Batida", "Mandarina Suave", "Vainilla Tropical"],
    effects: ["Relajación Alegre", "Euforia Sutil", "Calma Corporal", "Bienestar Completo"],
    activities: ["cooking", "chill", "movies"],
    description: "Una auténtica copa de helado para el paladar gourmet. Reúne los matices aterciopelados de banana dulce con el toque aromático de corteza de mandarina. Su efecto inicia con una agradable elevación sensorial antes de envolver el cuerpo en una plácida relajación.",
    image: "img/cff-banana-split.webp",
    visualColor: "linear-gradient(135deg, #EAB308 0%, #CA8A04 100%)",
    bgPattern: "radial-gradient(circle, rgba(234,179,8,0.25) 0%, transparent 70%)"
  },
  {
    ...
    indicaPct: 50,
    sativaPct: 50,
    genetics: "GG4 (Gorilla Glue #4) x Tangie",
    lineage: "Híbrido de potencia extrema que fusiona la resina pegajosa de GG4 con la fragancia cítrica de Tangie",
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 42, limonene: 38, myrcene: 20 },
    flavors: ["Pega Resinosa", "Naranja Amarga", "Combustible Kush", "Cítrico Terroso"],
    effects: ["Potencia Demoledora", "Subidón Cerebral", "Pesadez Física", "Euforia Psicodélica"],
    activities: ["gaming", "music", "art"],
    description: "Cruce titánico entre la ultra resinosa Gorilla Glue #4 y el semental Tangie de Crockett. Produce tricomas tan espesos que parecen savia derramada. Su impacto combina un colocón cerebral eufórico con una pesadez corporal muy gratificante.",
    image: "img/cff-citrus-sap.webp",
    visualColor: "linear-gradient(135deg, #10B981 0%, #059669 100%)",
    bgPattern: "radial-gradient(circle, rgba(16,185,129,0.25) 0%, transparent 70%)"
  },
  {
    id: "cff-crocketts-dawg",
    name: "Crockett's Dawg",
    bank: "Crockett Family Farms",
    species: "Híbrida",
    thc: 23.5,
    cbd: 0.3,
    ...
    indicaPct: 60,
    sativaPct: 40,
    genetics: "Guava Dawg x Family Secret",
    lineage: "Genética exclusiva de Crockett que combina Guava Dawg con una línea secreta familiar guardada durante generaciones",
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 44, myrcene: 32, pinene: 24 },
    flavors: ["Guayaba Tropical", "Gas Químico", "Especias Terrosas", "Pino Fuerte"],
    effects: ["Efecto Fuerte", "Concentración Profunda", "Alivio Muscular", "Relajación Duradera"],
    activities: ["focus", "reading", "night"],
    description: "Cepa insignia celosamente guardada por la familia Crockett. Su aroma combina notas tropicales de guayaba madura con un perfil 'dawg' químico y terroso de altísimo impacto. Efecto contundente, introspectivo y muy duradero.",
    image: "img/cff-crocketts-dawg.webp",
    visualColor: "linear-gradient(135deg, #14B8A6 0%, #0F766E 100%)",
    bgPattern: "radial-gradient(circle, rgba(20,184,166,0.25) 0%, transparent 70%)"
  },
  {
    id: "cff-strawberry-clem",
    name: "Strawberry Clem",
    bank: "Crockett Family Farms",
    species: "Híbrida",
    thc: 22.0,
    cbd: 0.4,
    ...
    indicaPct: 50,
    sativaPct: 50,
    genetics: "Strawberry Banana x Clementine",
    lineage: "Fusión magistral de la famosa Strawberry Banana con el vigor cítrico de Clementine",
    dominantTerpene: "limonene",
    terpenes: { limonene: 40, myrcene: 38, linalool: 22 },
    flavors: ["Batido de Fresa", "Clementina Dulce", "Golosinas Frutales", "Crema Cítrica"],
    effects: ["Alegría Desbordante", "Relajación Dulce", "Sensación Cálida", "Euforia Social"],
    activities: ["social", "cooking", "park"],
    description: "Sabor afrutado llevado a su máxima expresión. Combina la dulzura aterciopelada de fresas maduras de la Strawberry Banana con el brillo chispeante de Clementine. Una delicia aromática para los sentidos con un efecto equilibrado y alegre.",
    image: "img/cff-strawberry-clem.webp",
    visualColor: "linear-gradient(135deg, #F43F5E 0%, #E11D48 100%)",
    bgPattern: "radial-gradient(circle, rgba(244,63,94,0.25) 0%, transparent 70%)"
  },
  {
    id: "cff-strawberry-lemon-banana",
    name: "Strawberry Lemon Banana",
    bank: "Crockett Family Farms",
    species: "Híbrida",
    thc: 23.0,
    cbd: 0.3,
    ...
    indicaPct: 55,
    sativaPct: 45,
    genetics: "Strawberry Banana x Lemon Skunk",
    lineage: "Combinación tricómica explosiva de Strawberry Banana con toques picantes de limón fresco",
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 44, limonene: 36, caryophyllene: 20 },
    flavors: ["Fresa Cremosa", "Limón Confitado", "Plátano Dulce", "Pastelería Fina"],
    effects: ["Felicidad Acentuada", "Paz Mental", "Relajación Muscular", "Placer Gourmet"],
    activities: ["relax", "art", "music"],
    description: "Trilogía frutal extraordinaria donde confluyen fresas, limones frescos y plátano dulce en una textura resinosa brillante. Desarrolla cogollos prietos con aromas de repostería cannábica y un efecto que abraza mente y cuerpo con suavidad.",
    image: "img/cff-strawberry-lemon-banana.webp",
    visualColor: "linear-gradient(135deg, #FB7185 0%, #F43F5E 100%)",
    bgPattern: "radial-gradient(circle, rgba(251,113,133,0.25) 0%, transparent 70%)"
  },
  {
    id: "cff-tangie-jack",
    name: "Tangie Jack",
    ...
    indicaPct: 20,
    sativaPct: 80,
    genetics: "Jack Herer x Tangie",
    lineage: "Dos leyendas del cannabis sativa unidas en un híbrido de vigor imparable y terpenos penetrantes",
    dominantTerpene: "terpinolene",
    terpenes: { terpinolene: 45, pinene: 30, limonene: 25 },
    flavors: ["Haze Especiado", "Mandarina Pura", "Pino Resinoso", "Incienso Catedralicio"],
    effects: ["Subidón Estimulante", "Creatividad Sin Límites", "Euforia Espiritual", "Claridad Total"],
    activities: ["creativity", "writing", "hiking"],
    description: "Cruce legendario entre la histórica Jack Herer y la aromática Tangie. Ofrece cogollos alargados cargados de resina brillante, con notas profundas de incienso, pino y mandarina jugosa. Provoca un estado de lucidez, inspiración artística y entusiasmo inagotable.",
    image: "img/cff-tangie-jack.webp",
    visualColor: "linear-gradient(135deg, #06B6D4 0%, #0891B2 100%)",
    bgPattern: "radial-gradient(circle, rgba(6,182,212,0.25) 0%, transparent 70%)"
  },
  {
    id: "cff-banana-spritz",
    name: "Banana Spritz",
    bank: "Crockett Family Farms",
    species: "Híbrida",
    thc: 24.5,
    ...
    indicaPct: 65,
    sativaPct: 35,
    genetics: "Banana Sherbet x Spritzer",
    lineage: "Cruce moderno de alta gama que aporta un perfil cremoso y efervescente de terpenos exclusivos",
    dominantTerpene: "limonene",
    terpenes: { limonene: 42, caryophyllene: 36, myrcene: 22 },
    flavors: ["Burbujas Afrutadas", "Plátano Dulce", "Sorbet Exótico", "Gas Dulzón"],
    effects: ["Cosquilleo Eufórico", "Bienestar Suave", "Desconexión Placentera", "Sonrisa Radiante"],
    activities: ["party", "social", "gaming"],
    description: "Creación moderna de Crockett que combina la suavidad de Banana Sherbet con la efervescencia gaseosa de Spritzer. Produce cogollos densos de tonalidades verde lima con pistilos anaranjados brillantes. Su efecto es chispeante y lleno de diversión.",
    image: "img/cff-banana-spritz.webp",
  ...
  {
    id: "cff-malawi-moonshine",
    name: "Malawi Moonshine",
    bank: "Crockett Family Farms",
    species: "Sativa",
    thc: 23.5,
    cbd: 0.3,
    ...
    indicaPct: 15,
    sativaPct: 85,
    genetics: "Malawi Sativa x Moonshine Haze",
    lineage: "Sativa exótica de herencia africana cruzada con la prestigiosa genética Moonshine Haze de Crockett",
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 46, terpinolene: 32, caryophyllene: 22 },
    flavors: ["Madera Exótica", "Licor Añejo", "Especias Orientales", "Cítrico Oscuro"],
    effects: ["Viaje Cerebral Profundo", "Euforia Psicodélica", "Conexión Mental", "Energía Exótica"],
    activities: ["music", "meditation", "philosophy"],
    description: "Una de las sativas más singulares del mundo. Combina la indómita genética autóctona de Malawi con la finura aromática de Moonshine Haze. Desprende aromas complejos a maderas nobles, licor añejo y especias, regalando un viaje cerebral expansivo y meditativo.",
    image: "img/cff-malawi-moonshine.webp",
    visualColor: "linear-gradient(135deg, #F59E0B 0%, #B45309 100%)",
    bgPattern: "radial-gradient(circle, rgba(245,158,11,0.25) 0%, transparent 70%)"
  },

  // ==========================================
  // THE CALI CONNECTION (10 cepas)
  // ==========================================
  {
    id: "cali-sfv-og-kush",
    name: "SFV OG Kush",
    bank: "The Cali Connection",
    species: "Índica",
    thc: 25.0,
    cbd: 0.3,
    floweringDays: 63,
    ...
    lineage: "El clon madre original de San Fernando Valley cruzado y retrocruzado con Afghani #1 para fijar su legendario perfil de combustible terroso",
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 45, limonene: 30, caryophyllene: 25 },
    flavors: ["Queroseno / Diésel", "Pino Limonero", "Tierra Húmeda", "Cítrico Ácido"],
    effects: ["Sedación Profunda", "Alivio Muscular", "Calma Mental", "Paz Corporal"],
    activities: ["relax", "sleep", "movies"],
    description: "La variedad insignia indiscutible de The Cali Connection. Originaria del Valle de San Fernando en California, entrega un golpe clásico de OG Kush con potentes aromas a gasolina y limón sobre fondo terroso. Efecto corporal anestésico y serenidad absoluta.",
    image: "img/cali-sfv-og-kush.webp",
    visualColor: "linear-gradient(135deg, #047857 0%, #064E3B 100%)",
    bgPattern: "radial-gradient(circle, rgba(4,120,87,0.25) 0%, transparent 70%)"
  },
  {
    id: "cali-tahoe-og-kush",
    name: "Tahoe OG Kush",
    bank: "The Cali Connection",
    species: "Índica",
    thc: 24.5,
    ...
    indicaPct: 80,
    sativaPct: 20,
    genetics: "Tahoe OG Clone x SFV OG Kush IBL",
    lineage: "Selección del mítico clon Tahoe OG de Lake Tahoe cruzado con el macho SFV OG Kush IBL",
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 42, myrcene: 33, limonene: 25 },
    flavors: ["Limón Químico", "Combustible OG", "Madera de Pino", "Especias Terrosas"],
    effects: ["Desconexión Total", "Pesadez Corporal", "Antiestrés Intenso", "Somnolencia Plácida"],
    activities: ["sleep", "relax", "meditation"],
    description: "Conocida como una de las variantes de OG Kush más narcóticas y potentes del mundo. Desarrollada en la región de Lake Tahoe, produce cálices compactos rebosantes de resina picante. Un maridaje perfecto para disolver tensiones al final del día.",
    image: "img/cali-tahoe-og-kush.webp",
    visualColor: "linear-gradient(135deg, #065F46 0%, #022C22 100%)",
    bgPattern: "radial-gradient(circle, rgba(6,95,70,0.25) 0%, transparent 70%)"
  },
  {
    id: "cali-deadhead-og",
    ...
    indicaPct: 40,
    sativaPct: 60,
    genetics: "Chemdawg 91 Skunk VA x SFV OG Kush F4",
    lineage: "Hibridación maestra entre el legendario esqueje Chemdawg 91 Skunk VA y el macho SFV OG Kush F4",
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 40, caryophyllene: 35, pinene: 25 },
    flavors: ["Diésel Chem Fuerte", "Pino Picante", "Skunk Terroso", "Almizcle Intenso"],
    effects: ["Euforia Cerebral Lúcida", "Foco Creativo", "Vigor Mental", "Bienestar Físico"],
    activities: ["creative", "music", "social"],
    description: "Homenaje de Swerve a la cultura Grateful Dead. Combina la electricidad mental penetrante de Chemdawg 91 con la estructura resinosa de SFV OG. Cosecha cogollos aromáticos con una firma terpénica a combustible y almizcle penetrante.",
    image: "img/cali-deadhead-og.webp",
    visualColor: "linear-gradient(135deg, #10B981 0%, #047857 100%)",
    bgPattern: "radial-gradient(circle, rgba(16,185,129,0.25) 0%, transparent 70%)"
  },
  {
    ...
    lineage: "Cruce estelar entre Alien Kush (Las Vegas Purple Kush x Alien Dog) y Tahoe OG Kush",
    dominantTerpene: "limonene",
    terpenes: { limonene: 45, myrcene: 30, caryophyllene: 25 },
    flavors: ["Cítrico Espacial", "Resina de Pino", "Fuel Refinado", "Corteza de Limón"],
    effects: ["Viaje Psicoactivo Elevado", "Felicidad Radiante", "Relajación Serena", "Paz Espiritual"],
    activities: ["gaming", "nature", "movies"],
    description: "Una de las genéticas más veneradas de California por su astronómico contenido de THC. Sus cogollos presentan tonalidades verde lima escarchadas como meteoritos helados, desprendiendo una fragancia a pino y limón dulce de otro planeta.",
    image: "img/cali-alien-og.webp",
    visualColor: "linear-gradient(135deg, #84CC16 0%, #4D7C0F 100%)",
    bgPattern: "radial-gradient(circle, rgba(132,204,22,0.25) 0%, transparent 70%)"
  },
  {
    ...
    indicaPct: 85,
    sativaPct: 15,
    genetics: "Mendo Purps x San Fernando Valley OG Kush F3",
    lineage: "Unión de la famosa Mendo Purps del condado de Mendocino con el linaje SFV OG Kush F3",
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 48, caryophyllene: 28, linalool: 24 },
    flavors: ["Uva Oscura", "Moras Dulces", "Tierra Cafetera", "Pino Suave"],
    effects: ["Sedación Nocturna", "Alivio de Dolores", "Tranquilidad Mental", "Apetito Voraz"],
    activities: ["sleep", "relax", "gastronomy"],
    description: "Galardonada con el tercer puesto en la High Times Medical Cannabis Cup. Esta joya púrpura ofrece deslumbrantes matices violáceos con un bouquet embriagador a frutos del bosque oscuros y vino añejo. Su efecto calma cualquier agitación cotidiana.",
    image: "img/cali-blackwater.webp",
    visualColor: "linear-gradient(135deg, #7C3AED 0%, #4C1D95 100%)",
    bgPattern: "radial-gradient(circle, rgba(124,58,237,0.25) 0%, transparent 70%)"
  },
  {
    id: "cali-corleone-kush",
    name: "Corleone Kush",
    bank: "The Cali Connection",
    species: "Índica",
    thc: 23.5,
    ...
    indicaPct: 80,
    sativaPct: 20,
    genetics: "Pre-98 Bubba Kush x SFV OG Kush F4",
    lineage: "El clon supremo de Pre-98 Bubba Kush combinado con la fuerza estructurada del macho SFV OG Kush",
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 45, myrcene: 35, humulene: 20 },
    flavors: ["Café Tostado", "Hachís Afghano", "Cítricos Oscuros", "Pimienta Negra"],
    effects: ["Pesadez Agradable", "Paz Meditativa", "Relajación Muscular", "Confort Nocturno"],
    activities: ["relax", "reading", "sleep"],
    description: "Bautizada en honor al padrino, esta variedad impone respeto con cogollos densos como piedras y una gruesa capa de tricomas lechosos. Exhala fragancias a café espresso, chocolate amargo y hachís de la vieja escuela con toque kush.",
    image: "img/cali-corleone-kush.webp",
    visualColor: "linear-gradient(135deg, #78350F 0%, #451A03 100%)",
  ...
  },
  {
    ...
    indicaPct: 70,
    sativaPct: 30,
    genetics: "Death Star x SFV OG Kush F5",
    lineage: "Poderosa fusión del clon Death Star (Sour Diesel x Sensi Star) con el macho estabilizado SFV OG Kush F5",
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 42, limonene: 33, caryophyllene: 25 },
    flavors: ["Goma Quemada", "Sour Diésel", "Pino Fresco", "Matiz Metálico"],
    effects: ["Fuerza Jedi", "Euforia Serena", "Alivio Físico Profundo", "Claridad Mental"],
    activities: ["movies", "relax", "social"],
    description: "Ganadora en múltiples copas cannábicas, despierta 'la fuerza' en el consumidor con un balance impecable de bienestar físico y ligereza mental. Desprende un hedor intenso a caucho y queroseno que enamora a los puristas del diésel.",
    image: "img/cali-jedi-kush.webp",
    visualColor: "linear-gradient(135deg, #059669 0%, #064E3B 100%)",
    bgPattern: "radial-gradient(circle, rgba(5,150,105,0.25) 0%, transparent 70%)"
  },
  {
    id: "cali-larry-og-kush",
    name: "Larry OG Kush",
    bank: "The Cali Connection",
    species: "Índica",
    thc: 24.0,
    ...
    indicaPct: 70,
    sativaPct: 30,
    genetics: "Larry OG x SFV OG Kush IBL",
    lineage: "El famoso esqueje de Larry OG del condado de Orange llevado a semilla regular y feminizada con SFV OG Kush",
    dominantTerpene: "limonene",
    terpenes: { limonene: 44, myrcene: 32, caryophyllene: 24 },
    flavors: ["Limón Confitado", "Pino Balsámico", "Fuel Suave", "Toque Cremoso"],
    effects: ["Cerebral Positivo", "Relajación Fluida", "Buen Humor", "Descompresión"],
    activities: ["social", "nature", "gastronomy"],
    description: "Una de las favoritas en los dispensarios del sur de California por su perfil cítrico resinoso sin estridencias. Sus flores verde claro con pistilos anaranjados brillantes entregan un efecto amable que relaja sin noquear por completo.",
    image: "img/cali-larry-og-kush.webp",
    visualColor: "linear-gradient(135deg, #F59E0B 0%, #D97706 100%)",
    bgPattern: "radial-gradient(circle, rgba(245,158,11,0.25) 0%, transparent 70%)"
  },
  {
    ...
    indicaPct: 60,
    sativaPct: 40,
    genetics: "Tahoe OG Kush x Grape Romulan",
    lineage: "Cruce magistral entre el corte Tahoe OG y la legendaria Grape Romulan de Columbia Británica",
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 46, caryophyllene: 28, linalool: 26 },
    flavors: ["Uvas Maduras", "Golosina de Mosto", "Combustible OG", "Especias Florales"],
    effects: ["Alegría Cálida", "Relajación Suave", "Inspiración Agradable", "Bienestar"],
    activities: ["creative", "music", "movies"],
    description: "Deliciosa simbiosis entre la uva dulce especiada de Romulan y el combustible cítrico de Tahoe OG. Sus tricomas desprenden un aroma a mosto fermentado y bosque lluvioso, dejando una sensación de ligereza sumamente placentera.",
    image: "img/cali-grape-og.webp",
    visualColor: "linear-gradient(135deg, #8B5CF6 0%, #6D28D9 100%)",
    bgPattern: "radial-gradient(circle, rgba(139,92,246,0.25) 0%, transparent 70%)"
  },
  {
    id: "cali-girl-scout-cookies",
    name: "Girl Scout Cookies (Cali Connection)",
    bank: "The Cali Connection",
    species: "Híbrida",
    thc: 26.0,
    cbd: 0.2,
    ...
    indicaPct: 60,
    sativaPct: 40,
    genetics: "Forum Cut GSC x SFV OG Kush",
    lineage: "El esqueje original Forum Cut de San Francisco vigorizado y reforzado con el linaje SFV OG Kush",
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 46, limonene: 32, myrcene: 22 },
    flavors: ["Masa de Galleta Dulce", "Menta Fresca", "Chocolate Negro", "Toque Terroso OG"],
    effects: ["Euforia Risueña", "Éxtasis Sensorial", "Calma Corporal", "Paz Duradera"],
    activities: ["social", "gastronomy", "music"],
    description: "La interpretación californiana definitiva del fenómeno Girl Scout Cookies por Swerve. Añade robustez de tallo y rendimiento de resina a la complejidad horneada de GSC. Flores prietas repletas de terpenos reposteros de altísimo nivel.",
    image: "img/cali-girl-scout-cookies.webp",
    visualColor: "linear-gradient(135deg, #EC4899 0%, #BE185D 100%)",
    bgPattern: "radial-gradient(circle, rgba(236,72,153,0.25) 0%, transparent 70%)"
  },

  // ==========================================
  // CANNARADO GENETICS (10 cepas)
  // ==========================================
  {
    id: "cannarado-sundae-driver",
    name: "Sundae Driver",
    bank: "Cannarado Genetics",
    species: "Híbrida",
    thc: 24.0,
    cbd: 0.3,
    floweringDays: 65,
    ...
    lineage: "La obra maestra global de Cannarado que redefinió el mercado moderno: FPOG cruzado con Grape Pie",
    dominantTerpene: "limonene",
    terpenes: { limonene: 45, caryophyllene: 30, linalool: 25 },
    flavors: ["Helado de Vainilla", "Frutas Dulces", "Jarabe de Arándanos", "Toque Cremoso"],
    effects: ["Paz Mental Serena", "Felicidad Flotante", "Equilibrio Armónico", "Relajación Cálida"],
    activities: ["relax", "social", "movies"],
    description: "Fenómeno global y buque insignia de Cannarado Genetics. Famosa por sus flores tricolor con degradados violetas y glaseado cristalino. Su sabor recuerda a un sundae de helado bañado en mermelada de frutas silvestres con una calada extremadamente sedosa.",
    image: "img/cannarado-sundae-driver.webp",
    visualColor: "linear-gradient(135deg, #EC4899 0%, #8B5CF6 100%)",
    bgPattern: "radial-gradient(circle, rgba(236,72,153,0.25) 0%, transparent 70%)"
  },
  {
    id: "cannarado-wedding-pie",
    name: "Wedding Pie",
    bank: "Cannarado Genetics",
    species: "Índica",
    thc: 25.5,
    ...
    sativaPct: 30,
    genetics: "Wedding Cake x Grape Pie",
    lineage: "Poderosa alianza entre Wedding Cake (Pink Cookies) y el parental insigne Grape Pie",
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 44, myrcene: 32, limonene: 24 },
    flavors: ["Tarta de Uva Horneada", "Vainilla Especiada", "Gas Dulce", "Repostería Fina"],
    effects: ["Placer Somático", "Alivio Total de Tensión", "Sedación Placentera", "Sonrisa Serena"],
    activities: ["sleep", "relax", "gastronomy"],
    description: "Combinación celestial de dos de las cepas más sabrosas de la era moderna. Desprende una fragancia a pastel recién horneado cubierto de uvas caramelizadas y una capa penetrante de gas. Potencia anestésica de primer calibre.",
    image: "img/cannarado-wedding-pie.webp",
    visualColor: "linear-gradient(135deg, #A855F7 0%, #7E22CE 100%)",
    bgPattern: "radial-gradient(circle, rgba(168,85,247,0.25) 0%, transparent 70%)"
  },
  {
    id: "cannarado-apple-sundae",
    name: "Apple Sundae",
    bank: "Cannarado Genetics",
    species: "Híbrida",
    thc: 23.5,
    ...
    indicaPct: 40,
    sativaPct: 60,
    genetics: "Sour Apple x Sundae Driver",
    lineage: "Cruce entre el clon Sour Apple de acidez crujiente y el macho Sundae Driver",
    dominantTerpene: "pinene",
    terpenes: { pinene: 40, limonene: 35, caryophyllene: 25 },
    flavors: ["Manzana Verde Ácida", "Helado Suave", "Masa Quebrada", "Toque Refrescante"],
    effects: ["Chispazo Creativo", "Ánimo Radiante", "Ligereza Vital", "Conversación Fluida"],
    activities: ["creative", "social", "nature"],
    description: "Una bocanada de tarta de manzana crujiente recién sacada del horno con helado derretido. Sus notas ácidas y dulces activan la mente de forma limpia y expansiva, siendo idónea para proyectos artísticos y tardes compartidas.",
    image: "img/cannarado-apple-sundae.webp",
    visualColor: "linear-gradient(135deg, #84CC16 0%, #15803D 100%)",
    bgPattern: "radial-gradient(circle, rgba(132,204,22,0.25) 0%, transparent 70%)"
  },
  {
    id: "cannarado-birthday-cake",
    name: "Birthday Cake",
    bank: "Cannarado Genetics",
    species: "Índica",
    thc: 25.0,
    ...
    lineage: "También conocida como Wedding Cake en algunos círculos: GSC Forum Cut x Cherry Pie",
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 45, limonene: 30, myrcene: 25 },
    flavors: ["Glaseado de Vainilla", "Masa de Bizcocho", "Cerezas Silvestres", "Toque Terroso Dulce"],
    effects: ["Euforia Festiva", "Confort Integral", "Alivio Profundo", "Paz Mental"],
    activities: ["gastronomy", "movies", "relax"],
    description: "Una auténtica fiesta para los sentidos. Sus flores acumulan cálices apretados rebosantes de tricomas dorados con un perfume a masa de pastel de vainilla y toques de cereza. Provoca una profunda sensación de satisfacción y gozo interior.",
    image: "img/cannarado-birthday-cake.webp",
    visualColor: "linear-gradient(135deg, #F43F5E 0%, #BE123C 100%)",
    bgPattern: "radial-gradient(circle, rgba(244,63,94,0.25) 0%, transparent 70%)"
  },
  {
    id: "cannarado-banana-sundae",
    name: "Banana Sundae",
    bank: "Cannarado Genetics",
    species: "Híbrida",
    thc: 24.5,
    ...
    indicaPct: 60,
    sativaPct: 40,
    genetics: "Banana OG x Sundae Driver",
    lineage: "El mítico corte Banana OG ultra maduro polinizado por el macho selecto Sundae Driver",
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 45, limonene: 32, caryophyllene: 23 },
    flavors: ["Plátano Maduro", "Nata Montada", "Cacao Suave", "Frutas Tropicales"],
    effects: ["Sonrisa Continua", "Relajación Muscular", "Ganas de Reír", "Tranquilidad"],
    activities: ["gaming", "social", "movies"],
    description: "Delicioso postre botánico con sabor a batido de plátano con sirope de chocolate y crema chantilly. Produce cogollos voluminosos que desprenden un aroma tropical cautivador, manteniendo el ánimo elevado con una relajación muscular deliciosa.",
    image: "img/cannarado-banana-sundae.webp",
    visualColor: "linear-gradient(135deg, #EAB308 0%, #A16207 100%)",
    bgPattern: "radial-gradient(circle, rgba(234,179,8,0.25) 0%, transparent 70%)"
  },
  {
    id: "cannarado-biscotti-sundae",
    ...
    indicaPct: 70,
    sativaPct: 30,
    genetics: "Biscotti x Sundae Driver",
    lineage: "Cruce de altos vuelos entre el clon Biscotti (Gelato 25 x South Florida OG) y Sundae Driver",
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 48, limonene: 28, humulene: 24 },
    flavors: ["Galleta Italiana Tostada", "Crema Azucarada", "Diésel Suave", "Frutos Secos"],
    effects: ["Anestesia Suave", "Paz Espiritual", "Alivio Somático", "Desconexión"],
    activities: ["sleep", "relax", "reading"],
    description: "Una de las variedades más sofisticadas de la línea Sundae. Fusiona la complejidad aromática a galleta de almendra y masa tostada de Biscotti con el fondo cremoso frutal de Sundae Driver. Muy apreciada por extractores de hash solventless.",
    image: "img/cannarado-biscotti-sundae.webp",
    visualColor: "linear-gradient(135deg, #B45309 0%, #78350F 100%)",
    bgPattern: "radial-gradient(circle, rgba(180,83,9,0.25) 0%, transparent 70%)"
  },
  {
    id: "cannarado-kitchen-sink",
    name: "Kitchen Sink",
    bank: "Cannarado Genetics",
    species: "Índica",
    thc: 27.0,
    ...
    indicaPct: 75,
    sativaPct: 25,
    genetics: "GMO Cookies x Sundae Driver",
    lineage: "El colosal clon GMO Cookies (Garlic Cookies) atenuado y endulzado por Sundae Driver",
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 46, myrcene: 34, humulene: 20 },
    flavors: ["Ajo Asado Dulce", "Champiñón Terroso", "Gas Penetrante", "Miel de Flores"],
    effects: ["Potencia Demoledora", "Cuerpo Anestesiado", "Calma Absoluta", "Apagado Mental"],
    activities: ["sleep", "relax", "movies"],
    description: "Tiene 'de todo salvo el fregadero de la cocina'. Su perfil terpénico desafía lo convencional con matices a cebolla caramelizada, ajo confitado y crema dulce con combustible. Una de las cepas más potentes y resinadas de todo el banco.",
    image: "img/cannarado-kitchen-sink.webp",
    visualColor: "linear-gradient(135deg, #475569 0%, #1E293B 100%)",
    bgPattern: "radial-gradient(circle, rgba(71,85,105,0.25) 0%, transparent 70%)"
  },
  {
    id: "cannarado-pie-hoe",
    name: "Pie Hoe",
    bank: "Cannarado Genetics",
    species: "Índica",
    thc: 25.0,
    ...
    lineage: "Fusión del clásico clon Tahoe OG Kush con el aromático macho parental Grape Pie",
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 45, caryophyllene: 30, limonene: 25 },
    flavors: ["Uva Fermentada", "Fuel Terroso", "Pino Limonero", "Especias Picantes"],
    effects: ["Paz Instantánea", "Cuerpo Flotante", "Anti-Ansiedad", "Descanso Total"],
    activities: ["relax", "meditation", "sleep"],
    description: "Perfecto maridaje entre la garra terrosa y resinosa de Tahoe OG y la golosina morada de Grape Pie. Produce cálices alargados y pegajosos que liberan fragancias balsámicas ideales para meditaciones nocturnas y descanso regenerador.",
    image: "img/cannarado-pie-hoe.webp",
    visualColor: "linear-gradient(135deg, #7C3AED 0%, #5B21B6 100%)",
    bgPattern: "radial-gradient(circle, rgba(124,58,237,0.25) 0%, transparent 70%)"
  },
  {
    id: "cannarado-5-alive",
    name: "5 Alive",
    bank: "Cannarado Genetics",
    species: "Sativa",
    thc: 23.0,
    ...
    lineage: "Trilogía cítrica y golosa creada combinando Bubblegum, Orange Juice y Grape Pie",
    dominantTerpene: "terpinolene",
    terpenes: { terpinolene: 42, limonene: 36, pinene: 22 },
    flavors: ["Zumo Multivitamínico", "Naranja Sangre", "Pomelo Rosa", "Golosina Tropical"],
    effects: ["Energía Chispeante", "Motivación Pura", "Sonrisa Extrema", "Claridad Luminosa"],
    activities: ["nature", "creative", "social"],
    description: "Una auténtica explosión de zumo cítrico recién exprimido. Despierta los sentidos de inmediato con vibraciones eufóricas y lúcidas que disipan la apatía. Excelente para caminatas en la naturaleza, deportes o actividades al aire libre.",
    image: "img/cannarado-5-alive.webp",
    visualColor: "linear-gradient(135deg, #F97316 0%, #C2410C 100%)",
    bgPattern: "radial-gradient(circle, rgba(249,115,22,0.25) 0%, transparent 70%)"
  },
  {
    id: "cannarado-birthday-funk",
    name: "Birthday Funk",
    bank: "Cannarado Genetics",
    species: "Índica",
    thc: 26.0,
    ...
    indicaPct: 70,
    sativaPct: 30,
    genetics: "Birthday Cake x Dosidos",
    lineage: "Alianza colosal entre Birthday Cake y el parental élite Dosidos de NorCal",
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 46, limonene: 32, linalool: 22 },
    flavors: ["Mantequilla Horneada", "Funk Terroso", "Mora Silvestre", "Lavanda Dulce"],
    effects: ["Calidez Corporal", "Felicidad Profunda", "Sedación Plácida", "Alivio Cerebral"],
    activities: ["music", "relax", "sleep"],
    description: "Variedad de linaje aristocrático que aúna la dulzura pastelera de Birthday Cake con el carácter funky y floral de Dosidos. Flores de color púrpura profundo cuajadas de resina que proporcionan un bienestar corporal inigualable.",
    image: "img/cannarado-birthday-funk.webp",
    visualColor: "linear-gradient(135deg, #6366F1 0%, #4338CA 100%)",
    bgPattern: "radial-gradient(circle, rgba(99,102,241,0.25) 0%, transparent 70%)"
  }
