...
const STRAINS_DATABASE = [
  {
        ...
        aroma: "Caramelo de frutas dulces, menta fresca y matices terrosos",
        flavors: ["Caramelo de Frutas", "Menta Fresca", "Matices Terrosos"],
        effects: ["Relajación Corporal", "Euforia Suave", "Bienestar"],
        activities: ["relax_sleep", "social", "gaming"],
        description: "Kmintz de Ripper Seeds une dos clones de élite mundial: Zkittlez y Kush Mints. Destaca por mejorar la densidad floral y producción de resina de Zkittlez manteniendo su asombroso sabor a caramelos frutales con un postgusto mentolado fresco muy persistente.",
      ...
      },
  {
        ...
        lineage: "Kosher Kush x The OG #18",
        origin: "Los Ángeles, EE.UU.",
        dominantTerpene: "caryophyllene",
        terpenes: { caryophyllene: 40, myrcene: 35, limonene: 25 },
        aroma: "Pino penetrante, combustible Kush espeso y especias aromáticas",
        flavors: ["Pino Penetrante", "Combustible Kush", "Especias Aromáticas"],
  ...
  },
  {
    ...
    genetics: "Black Domina selección x White Widow",
    lineage: "Black Domina x White Widow",
    name: "White Domina",
    bank: "Kannabia Seeds",
    species: "Índica",
    thc: 22,
    ...
    sativaPct: 10,
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 55, caryophyllene: 30, linalool: 15 },
    flavors: ["Hash Afgano", "Tierra Húmeda", "Madera Oscura"],
    effects: ["Relajación Profunda", "Sedación", "Alivio Físico"],
    activities: ["relaxation", "sleep", "meditation"],
    description: "White Domina de Kannabia Seeds es una Índica pura de referencia en el mercado español. Cruza de Afghan x Black Domina x Ortega x Hash Plant, produce cogollos densos y compactos chorreantes de resina con un efecto potente y narcótico ideal para el descanso nocturno.",
    image: "img/kannabia-white-domina.webp",
    visualColor: "linear-gradient(135deg, #1a1a2e 0%, #6B7280 100%)",
    bgPattern: "radial-gradient(circle, rgba(107,114,128,0.2) 0%, transparent 70%)"
  },
  {
    id: "kannabia-uk-cheese",
    genetics: "Skunk #1 x Cheese original",
    lineage: "Skunk #1 x Cheese",
    name: "UK Cheese",
    bank: "Kannabia Seeds",
    species: "Índica",
    thc: 20,
    ...
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 45, myrcene: 35, limonene: 20 },
    flavors: ["Queso Añejo", "Ácido Pungente", "Herbal Terroso"],
    effects: ["Euforia Alegre", "Relajación Corporal", "Sociabilidad"],
    activities: ["social", "relaxation", "creativity"],
    description: "La UK Cheese de Kannabia es la versión española del clon legendario Exodus Cheese. Aroma penetrante a queso azul, con un perfil de cariofileno dominante y efecto equilibrado cuerpo-mente que la ha convertido en favorita entre los cultivadores europeos.",
    image: "img/kannabia-uk-cheese.webp",
    visualColor: "linear-gradient(135deg, #92400E 0%, #D97706 100%)",
    bgPattern: "radial-gradient(circle, rgba(217,119,6,0.2) 0%, transparent 70%)"
  },
  {
    id: "kannabia-karibbean-mango",
    genetics: "Mango Skunk x Black Domina",
    lineage: "Mango Skunk x Black Domina",
    name: "Karibbean Mango",
    bank: "Kannabia Seeds",
    species: "Sativa",
    thc: 21,
    cbd: 0.2,
    ...
    sativaPct: 70,
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 50, terpinolene: 30, ocimene: 20 },
    flavors: ["Mango Tropical", "Frutas Exóticas", "Dulce Afrutado"],
    effects: ["Euforia Tropical", "Energía Creativa", "Bienestar General"],
    activities: ["creativity", "social", "outdoor"],
    description: "Karibbean Mango de Kannabia Seeds destila el sabor del Caribe en cada puff. Sativa tropical de perfil miercénico intenso con aroma a mango maduro y papaya fresca. Efecto elevador y social, ideal para actividades al aire libre y exploración creativa.",
    image: "img/kannabia-karibbean-mango.webp",
    visualColor: "linear-gradient(135deg, #D97706 0%, #F59E0B 100%)",
    bgPattern: "radial-gradient(circle, rgba(245,158,11,0.2) 0%, transparent 70%)"
  },
  {
    id: "kannabia-amnesia",
    genetics: "Amnesia Haze x White Widow",
    lineage: "Amnesia Haze x White Widow",
    name: "Amnesia Kannabia",
    bank: "Kannabia Seeds",
    species: "Sativa",
    thc: 22,
    cbd: 0.1,
    ...
    flavors: ["Haze Clásico", "Limón Fresco", "Terroso Especiado"],
    effects: ["Psicoactividad Intensa", "Creatividad Desbordante", "Euforia"],
    activities: ["creativity", "social", "meditation"],
    description: "La Amnesia de Kannabia Seeds es la interpretación catalana del genoma Haze x Afghani indispensable en cualquier catálogo premium. Producción destacada, cogollos alargados cubiertos de tricomas dorados y un alto que desconecta la mente con elegancia.",
    image: "img/kannabia-amnesia.webp",
    visualColor: "linear-gradient(135deg, #F59E0B 0%, #10B981 100%)",
    bgPattern: "radial-gradient(circle, rgba(16,185,129,0.2) 0%, transparent 70%)"
  },
  {
    id: "kannabia-referral-kush",
    ...
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 50, caryophyllene: 30, linalool: 20 },
    flavors: ["Combustible OG", "Tierra Kush", "Pino Húmedo"],
    effects: ["Relajación Intensa", "Efecto Cuerpo Completo", "Calma Mental"],
    activities: ["relaxation", "sleep", "meditation"],
    description: "Referral Kush es la variedad estrella de Kannabia para los amantes del linaje OG/Kush. Con 24% de THC y una expresión típicamente Indica, produce cogollos densos con aroma a combustible, tierra y pino. Efectos relajantes de larga duración.",
    image: "img/kannabia-referral-kush.webp",
    visualColor: "linear-gradient(135deg, #064E3B 0%, #059669 100%)",
    bgPattern: "radial-gradient(circle, rgba(5,150,105,0.2) 0%, transparent 70%)"
  },
  {
    id: "kannabia-mimosa-dream",
    genetics: "Clementine x Purple Punch",
    ...
    dominantTerpene: "limonene",
    terpenes: { limonene: 50, terpinolene: 30, ocimene: 20 },
    flavors: ["Naranja Fresca", "Cítrico Efervescente", "Tropical Dulce"],
    effects: ["Euforia Matutina", "Energía Enfocada", "Bienestar Elevado"],
    activities: ["social", "creativity", "workout"],
    description: "Mimosa Dream de Kannabia captura la esencia de la cepa californiana Mimosa (Purple Punch x Clementine) con perfil cítrico vibrante y efecto eufórico brillante. Perfecta para el día, sus cogollos densos desprenden aroma a naranja fresca y mango.",
    image: "img/kannabia-mimosa-dream.webp",
    visualColor: "linear-gradient(135deg, #F97316 0%, #FBBF24 100%)",
    bgPattern: "radial-gradient(circle, rgba(251,191,36,0.2) 0%, transparent 70%)"
  },
  {
    id: "kannabia-purple-kush",
    genetics: "Black Domina x Purple Afghani",
    lineage: "Black Domina x Purple Afghani",
    name: "Purple Kush Kannabia",
    bank: "Kannabia Seeds",
    species: "Índica",
    thc: 21,
    cbd: 0.3,
    ...
    sativaPct: 0,
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 60, linalool: 25, caryophyllene: 15 },
    flavors: ["Uva Morada", "Hash Dulce", "Tierra Floral"],
    effects: ["Sedación Profunda", "Relajación Muscular Total", "Alivio del Dolor"],
    activities: ["sleep", "relaxation", "meditation"],
    description: "Purple Kush Kannabia es Indica pura al 100% — descendiente directa de Hindu Kush x Purple Afghani. Sus cogollos se tiñen de morado intenso bajo temperaturas frescas. Uno de los mejores sedantes naturales del catálogo, con sabor a hash y uva morada.",
    image: "img/kannabia-purple-kush.webp",
    visualColor: "linear-gradient(135deg, #4C1D95 0%, #7C3AED 100%)",
    bgPattern: "radial-gradient(circle, rgba(124,58,237,0.2) 0%, transparent 70%)"
  },
  {
    id: "kannabia-stonewall",
    genetics: "Northern Lights x Hashplant",
    lineage: "Northern Lights x Hashplant",
    name: "Stonewall",
    bank: "Kannabia Seeds",
    species: "Híbrida",
    thc: 22,
    ...
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 40, myrcene: 35, pinene: 25 },
    flavors: ["Madera Especiada", "Combustible Suave", "Fruta Tropical"],
    effects: ["Equilibrio Perfecto Cuerpo-Mente", "Creatividad Relajada", "Euforia Suave"],
    activities: ["social", "creativity", "relaxation"],
    description: "Stonewall de Kannabia Seeds es una híbrida perfectamente equilibrada que lleva el linaje de Chemdawg a territorio europeo. Aroma complejo a madera, especias y un fondo fresco afrutado. Efecto bifásico: euforia mental inicial seguida de relajación corporal.",
    image: "img/kannabia-stonewall.webp",
    visualColor: "linear-gradient(135deg, #374151 0%, #6B7280 100%)",
    bgPattern: "radial-gradient(circle, rgba(107,114,128,0.2) 0%, transparent 70%)"
  },
  {
    id: "kannabia-baby-boom",
    genetics: "Northern Lights x Blueberry",
    ...
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 45, caryophyllene: 35, limonene: 20 },
    flavors: ["Dulce Floral", "Frutas Silvestres", "Cremoso"],
    effects: ["Relajación Alegre", "Buen Humor", "Descanso Suave"],
    activities: ["relaxation", "social", "sleep"],
    description: "Baby Boom Fotoperiódica de Kannabia Seeds es una productora masiva reconocida por su rendimiento extraordinario y facilidad de cultivo. Cogollos compactos de tamaño notable con resina abundante, sabor dulce y frutal, y efecto equilibrado muy apreciado por cultivadores de todas las experiencias.",
    image: "img/kannabia-baby-boom.webp",
    visualColor: "linear-gradient(135deg, #065F46 0%, #34D399 100%)",
    bgPattern: "radial-gradient(circle, rgba(52,211,153,0.2) 0%, transparent 70%)"
  },
  {
    id: "kannabia-russian-doll",
    genetics: "Northern Lights x AK-47 x Kuban Killer",
    lineage: "NL x AK-47 x Kuban Killer",
    name: "Russian Doll",
    bank: "Kannabia Seeds",
    species: "Índica",
    thc: 23,
    ...
    sativaPct: 20,
    dominantTerpene: "linalool",
    terpenes: { linalool: 40, myrcene: 40, caryophyllene: 20 },
    flavors: ["Floral Suave", "Hash Clásico", "Dulce Herbal"],
    effects: ["Relajación Profunda", "Paz Mental", "Sueño Reparador"],
    activities: ["sleep", "relaxation", "meditation"],
    description: "Russian Doll de Kannabia Seeds es una Indica de origen afgano con expresión floral y linalool dominante. Su linaje incluye genética rusa de alta montaña, aportando una floración densa, cogollos compactos perfumados y un efecto sedante con notas de tranquilidad absoluta.",
    image: "img/kannabia-russian-doll.webp",
  ...
  },
  {
    ...
    sativaPct: 50,
    dominantTerpene: "limonene",
    terpenes: { limonene: 50, myrcene: 30, terpinolene: 20 },
    flavors: ["Naranja Valencia", "Cítrico Intenso", "Dulce Herbal"],
    effects: ["Alegría Elevada", "Energía Creativa", "Bienestar Social"],
    activities: ["social", "creativity", "outdoor"],
    description: "California Orange Bud de Kera Seeds es la heredera directa de la legendaria California Orange de los años 80. Híbrida equilibrada con explosivo aroma a naranja fresca, cogollos densos de tricomas y efecto alegre y funcional que no abruma.",
    image: "img/kera-california-orange.webp",
    visualColor: "linear-gradient(135deg, #EA580C 0%, #F97316 100%)",
    bgPattern: "radial-gradient(circle, rgba(249,115,22,0.2) 0%, transparent 70%)"
  },
  {
    id: "kera-crystal-meth",
    genetics: "Destroyer x Critical Bilbo",
    lineage: "Destroyer x Critical Bilbo",
    name: "Crystal Meth Kera",
    bank: "Kera Seeds",
    species: "Sativa",
    thc: 24,
    cbd: 0.1,
    ...
    dominantTerpene: "terpinolene",
    terpenes: { terpinolene: 45, limonene: 35, pinene: 20 },
    flavors: ["Diesel Suave", "Frutas Tropicales", "Haze Clásico"],
    effects: ["Euforia Cerebral Intensa", "Creatividad Explosiva", "Energía Mental"],
    activities: ["creativity", "social", "workout"],
    description: "Crystal Meth de Kera Seeds no debe su nombre a sustancias ilegales sino a la cobertura cristalina sobrenatural de sus cogollos. Con 24% de THC y fenotipo Sativa, produce una experiencia mental estimulante y creativa con aroma a diesel tropical.",
    image: "img/kera-crystal-meth.webp",
    visualColor: "linear-gradient(135deg, #0E7490 0%, #06B6D4 100%)",
    bgPattern: "radial-gradient(circle, rgba(6,182,212,0.2) 0%, transparent 70%)"
  },
  {
    id: "kera-cherry-pie-kera",
    genetics: "Granddaddy Purple x F1 Durb",
    lineage: "GDP x F1 Durb",
    name: "Cherry Pie Kera",
    bank: "Kera Seeds",
    species: "Índica",
    thc: 22,
    cbd: 0.3,
    ...
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 40, myrcene: 35, linalool: 25 },
    flavors: ["Cereza Dulce", "Masa Horneada", "Frutal Ácido"],
    effects: ["Relajación Feliz", "Bienestar Físico", "Euforia Suave"],
    activities: ["relaxation", "social", "creativity"],
    description: "Cherry Pie Kera captura el linaje de Grandaddy Purple x Durban Poison en expresión europea. Sus cogollos densos y compactos desprenden aroma irresistible a tarta de cerezas recién horneada con fondo terroso. Efecto equilibrado con predominio relaxante.",
    image: "img/kera-cherry-pie-kera.webp",
    visualColor: "linear-gradient(135deg, #9F1239 0%, #E11D48 100%)",
    bgPattern: "radial-gradient(circle, rgba(225,29,72,0.2) 0%, transparent 70%)"
  },
  {
    id: "kera-gorilla-glue-kera",
    genetics: "Chem's Sister x Sour Dubb x Chocolate Diesel",
    lineage: "Chem's Sister x Sour Dubb x Chocolate Diesel",
    name: "Gorilla Glue Kera",
    bank: "Kera Seeds",
    species: "Híbrida",
    thc: 26,
    cbd: 0.2,
    ...
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 45, myrcene: 35, limonene: 20 },
    flavors: ["Tierra Húmeda", "Café Oscuro", "Combustible Suave"],
    effects: ["Pegue Intenso", "Relajación Cuerpo Completo", "Euforia Profunda"],
    activities: ["relaxation", "sleep", "meditation"],
    description: "La Gorilla Glue #4 de Kera Seeds es su versión estabilizada del gen Chem's Sister x Sour Dubb x Chocolate Diesel. Con 26% THC, produce cantidades industriales de resina pegajosa que literalmente pegan las tijeras durante la poda. Efectos demoledores y de larga duración.",
    image: "img/kera-gorilla-glue-kera.webp",
    visualColor: "linear-gradient(135deg, #1C1917 0%, #57534E 100%)",
    bgPattern: "radial-gradient(circle, rgba(87,83,78,0.2) 0%, transparent 70%)"
  },
  {
    id: "kera-strawberry-cough-kera",
    genetics: "Strawberry Field x Haze",
    lineage: "Strawberry Field x Haze",
    name: "Strawberry Cough Kera",
    bank: "Kera Seeds",
    species: "Sativa",
    thc: 20,
    cbd: 0.2,
    ...
    sativaPct: 80,
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 40, terpinolene: 35, ocimene: 25 },
    flavors: ["Fresa Madura", "Frutal Dulce", "Floral Suave"],
    effects: ["Euforia Alegre", "Socialización Expansiva", "Uplifting"],
    activities: ["social", "creativity", "outdoor"],
    description: "Strawberry Cough Kera es la versión del clásico de Kyle Kushman para el mercado europeo. Sativa de aroma inconfundible a fresas maduras que produce un efecto ascendente, expansivo y perfectamente social. Sus cogollos alargados se cubren de pistilos rosados.",
    image: "img/kera-strawberry-cough-kera.webp",
    visualColor: "linear-gradient(135deg, #BE123C 0%, #FB7185 100%)",
    bgPattern: "radial-gradient(circle, rgba(251,113,133,0.2) 0%, transparent 70%)"
  },
  {
    id: "kera-lemon-haze-kera",
    genetics: "Lemon Skunk x Amnesia Haze",
    lineage: "Lemon Skunk x Amnesia Haze",
    name: "Lemon Haze Kera",
    bank: "Kera Seeds",
    species: "Sativa",
    thc: 22,
    cbd: 0.1,
    ...
    dominantTerpene: "limonene",
    terpenes: { limonene: 55, terpinolene: 30, pinene: 15 },
    flavors: ["Limón Exprimido", "Haze Clásico", "Cítrico Suave"],
    effects: ["Claridad Mental", "Energía Creativa", "Bienestar Elevado"],
    activities: ["creativity", "social", "workout"],
    description: "Lemon Haze de Kera Seeds es el cruce de Lemon Skunk x Silver Haze que ha conquistado el paladar europeo. Explosivo aroma a limón fresco con fondo hazeado, cogollos alargados de amarillo dorado y un efecto estimulante, claro y funcional.",
    image: "img/kera-lemon-haze-kera.webp",
    visualColor: "linear-gradient(135deg, #713F12 0%, #EAB308 100%)",
    bgPattern: "radial-gradient(circle, rgba(234,179,8,0.2) 0%, transparent 70%)"
  },
  {
    id: "kera-critical-kush-kera",
    genetics: "Critical Mass x OG Kush",
    lineage: "Critical Mass x OG Kush",
    name: "Critical Kush Kera",
    bank: "Kera Seeds",
    species: "Índica",
    thc: 20,
    cbd: 0.5,
    ...
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 55, caryophyllene: 30, linalool: 15 },
    flavors: ["Tierra Kush", "Hash Dulce", "Herbal Especiado"],
    effects: ["Cuerpo Fundido", "Paz Mental", "Sueño Profundo"],
    activities: ["sleep", "relaxation", "meditation"],
    description: "Critical Kush de Kera Seeds fusiona Critical Mass con OG Kush para crear una Indica de producción masiva con efectos profundamente sedantes. Floración ultra-rápida de 56 días, cogollos enormes y densos, y perfil de terpenos que combina tierra, hash y dulzura.",
    image: "img/kera-critical-kush-kera.webp",
    visualColor: "linear-gradient(135deg, #14532D 0%, #22C55E 100%)",
    bgPattern: "radial-gradient(circle, rgba(34,197,94,0.2) 0%, transparent 70%)"
  },
  {
    id: "kera-pineapple-chunk-kera",
    genetics: "Pineapple x Skunk #1 x Cheese",
    lineage: "Pineapple x Skunk x Cheese",
    name: "Pineapple Chunk Kera",
    bank: "Kera Seeds",
    species: "Índica",
    thc: 21,
    cbd: 0.3,
    ...
    sativaPct: 25,
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 45, limonene: 35, terpinolene: 20 },
    flavors: ["Piña Tropical", "Frutal Dulce", "Queso Suave"],
    effects: ["Relajación Alegre", "Bienestar Corporal", "Euforia Tranquila"],
    activities: ["relaxation", "social", "creativity"],
    description: "Pineapple Chunk de Kera Seeds combina Pineapple, Skunk #1 y Cheese en una Indica prolífica de sabor exótico. Sus cogollos emiten un aroma inconfundible a piña tropical madura con fondo quesoso. Efecto relajante y elevador ideal para la tarde-noche.",
    image: "img/kera-pineapple-chunk-kera.webp",
    visualColor: "linear-gradient(135deg, #78350F 0%, #F59E0B 100%)",
    bgPattern: "radial-gradient(circle, rgba(245,158,11,0.2) 0%, transparent 70%)"
  },
  {
    id: "kera-purple-haze-kera",
    genetics: "Purple Thai x Haze",
    lineage: "Purple Thai x Haze",
    name: "Purple Haze Kera",
    bank: "Kera Seeds",
    species: "Sativa",
    thc: 20,
    cbd: 0.2,
    ...
    flavors: ["Uva Dulce", "Haze Especiado", "Frutas del Bosque"],
    effects: ["Psicoactividad Cerebral", "Creatividad Vibrante", "Euforia Colorida"],
    activities: ["creativity", "meditation", "social"],
    description: "Purple Haze Kera rinde homenaje al clásico de Jimi Hendrix y al linaje Haze x Purple Thai original. Sativa pura de floración larga pero cogollos alargados con tonos morados y un efecto mental psicoactivo, vibrante y creativo que transporta la mente.",
    image: "img/kera-purple-haze-kera.webp",
    visualColor: "linear-gradient(135deg, #3B0764 0%, #A855F7 100%)",
    bgPattern: "radial-gradient(circle, rgba(168,85,247,0.2) 0%, transparent 70%)"
  },
  {
    id: "kera-white-widow-kera",
    genetics: "Brazilian Sativa x South Indian Indica",
    lineage: "Brazilian x South Indian",
    name: "White Widow Kera",
    bank: "Kera Seeds",
    species: "Híbrida",
    thc: 20,
    cbd: 0.3,
    ...
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 40, myrcene: 35, pinene: 25 },
    flavors: ["Tierra Húmeda", "Madera Blanca", "Especias Suaves"],
    effects: ["Euforia Equilibrada", "Creatividad Accesible", "Relajación Suave"],
    activities: ["social", "creativity", "relaxation"],
    description: "White Widow de Kera Seeds es la interpretación europea de la leyenda blanca de los coffeeshops holandeses. Brazilian Sativa x South Indian Indica estabilizada para expresión máxima de resina blanca. Un clásico imprescindible con efecto equilibrado y versátil.",
    image: "img/kera-white-widow-kera.webp",
  ...
  },
  {
    ...
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 55, caryophyllene: 30, limonene: 15 },
    flavors: ["Dulce Frutal", "Tierra Herbal", "Madera Suave"],
    effects: ["Relajación Rápida", "Bienestar Corporal", "Descanso"],
    activities: ["relaxation", "sleep", "meditation"],
    description: "Critical de Royal Queen Seeds es una de las variedades más cultivadas de España gracias a su producción explosiva y floración ultra-corta. Cruce de Afghani x Skunk con expresión Indica dominante, cogollos enormes y compactos y efecto relajante accesible.",
    image: "img/rqs-critical.webp",
    visualColor: "linear-gradient(135deg, #1D4ED8 0%, #3B82F6 100%)",
    bgPattern: "radial-gradient(circle, rgba(59,130,246,0.2) 0%, transparent 70%)"
  },
  {
    id: "rqs-special-kush-1",
    genetics: "Afghan Kush x Skunk",
    lineage: "Afghan Kush x Skunk",
    name: "Special Kush #1",
    bank: "Royal Queen Seeds",
    species: "Índica",
    thc: 17,
    ...
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 60, linalool: 25, caryophyllene: 15 },
    flavors: ["Hash Afghano", "Tierra Dulce", "Herbal Profundo"],
    effects: ["Sedación Relajada", "Paz Interior", "Alivio Físico"],
    activities: ["sleep", "relaxation", "meditation"],
    description: "Special Kush #1 de Royal Queen Seeds destila la pureza del linaje Afghani en una variedad accesible para todos los niveles de cultivo. Floración de solo 48 días, cogollos densos con aroma a hash clásico y efecto tranquilizante ideal para el fin de la jornada.",
    image: "img/rqs-special-kush-1.webp",
  ...
  },
  {
    ...
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 50, caryophyllene: 30, pinene: 20 },
    flavors: ["Skunk Clásico", "Fruta Dulce", "Tierra Herbal"],
    effects: ["Euforia Relajada", "Cuerpo Fundido", "Bienestar"],
    activities: ["relaxation", "social", "sleep"],
    description: "Shiva Skunk de Sensi Seeds es el resultado del cruce de Northern Lights #5 x Skunk #1 — dos de las genéticas más influyentes de la historia del cannabis. Produce cogollos masivos, densos y aromáticos con sabor a skunk clásico y fondo dulce afrutado.",
    image: "img/sensi-shiva-skunk.webp",
    visualColor: "linear-gradient(135deg, #065F46 0%, #34D399 100%)",
    bgPattern: "radial-gradient(circle, rgba(52,211,153,0.2) 0%, transparent 70%)"
  },
  {
    id: "sensi-big-bud",
    genetics: "Afghan Indica x Skunk #1",
    ...
    sativaPct: 15,
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 60, caryophyllene: 25, linalool: 15 },
    flavors: ["Dulce Suave", "Frutal Herbal", "Tierra Amaderada"],
    effects: ["Relajación Corporal Profunda", "Sedación Agradable", "Paz"],
    activities: ["relaxation", "sleep", "meditation"],
    description: "Big Bud de Sensi Seeds es la campeona absoluta de producción en el linaje Afghani x Skunk #1 x Northern Lights. Sus cogollos alcanzan tamaños colosales con estructura densa y cristalina. Ganadora de múltiples Cannabis Cups, es referencia de rendimiento máximo en cultivo Indica.",
    image: "img/sensi-big-bud.webp",
  ...
  },
  {
    ...
    genetics: "Moroccan Beldia Landrace (Rif Mountains)",
    ...
    dominantTerpene: "terpinolene",
    terpenes: { terpinolene: 50, pinene: 30, limonene: 20 },
    flavors: ["Kif Marroquí", "Especias del Atlas", "Floral Seco"],
    effects: ["Psicoactividad Cerebral Pura", "Introspección", "Creatividad Elevada"],
    activities: ["meditation", "creativity", "social"],
    description: "Morocco Beldia Kif de ACE Seeds es una selección de landrace marroquí puro de las montañas del Rif y el Atlas. Sativa de floración larga con efecto cerebral limpio y psicoactivo, herencia directa de las plantas que durante siglos han producido el kif y el haschis del Magreb.",
    image: "img/aceseeds-morocco-beldia.webp",
    visualColor: "linear-gradient(135deg, #92400E 0%, #D97706 100%)",
    bgPattern: "radial-gradient(circle, rgba(217,119,6,0.2) 0%, transparent 70%)"
  },
  {
    id: "aceseeds-zamal",
    genetics: "Zamal Landrace (Reunion) x A5 Haze (NL#5 x Haze A)",
    lineage: "Zamal x A5 Haze",
    name: "Zamal A5 Haze",
    bank: "ACE Seeds",
    species: "Sativa",
    thc: 19,
    ...
    dominantTerpene: "terpinolene",
    terpenes: { terpinolene: 55, limonene: 25, ocimene: 20 },
    flavors: ["Tropical Exótico", "Frutas Reunionesas", "Haze Especiado"],
    effects: ["Vuelo Mental Elevado", "Psicoactividad Pura", "Expansión de Consciencia"],
    activities: ["meditation", "creativity", "outdoor"],
    description: "Zamal A5 Haze de ACE Seeds es una de las sativas más puras y raras del catálogo. Landrace de la isla de La Reunión (océano Índico) seleccionada en la línea A5 por ACE Seeds — floración extrema de 100 días con efecto psicoactivo cerebral sin igual, digno de los grandes Hazes históricos.",
    image: "img/aceseeds-zamal.webp",
    visualColor: "linear-gradient(135deg, #0C4A6E 0%, #0EA5E9 100%)",
    bgPattern: "radial-gradient(circle, rgba(14,165,233,0.2) 0%, transparent 70%)"
  },
  {
    id: "barneys-biscotti-mintz",
    image: "img/barneys-biscotti-mintz.webp",
    name: "Biscotti Mintz",
    aka: "Biscotti x Mintz",
    bank: "Barney's Farm",
    species: "Índica",
    thc: 26, cbd: 0.1,
    indicaPct: 80, sativaPct: 20,
    yieldIndoor: 600, yieldOutdoor: 800,
    floweringDays: 60, rating: 4.9, reviewsCount: 620,
    genetics: "Biscotti x Mintz",
    lineage: "Biscotti x Mintz",
    origin: "Costa Oeste, EE.UU. / Países Bajos",
    dominantTerpene: "limonene",
    terpenes: { limonene: 45, caryophyllene: 30, myrcene: 25 },
    aroma: "Menta dulce de galleta, especias cremosas y fondo diésel",
    flavors: ["Galleta Dulce", "Menta Cremosa", "Kush Diésel"],
    effects: ["Relajación Profunda", "Calma Creativa", "Euforia Mental"],
    activities: ["relax_sleep", "music", "gaming"],
    description: "Biscotti Mintz de Barney's Farm es una obra maestra de la Costa Oeste que combina la legendaria Biscotti con una selección exclusiva de Mintz. Sus cogollos muestran tonos púrpuras profundos con tricomas brillantes, desprendiendo un aroma embriagador a galletas recién horneadas con menta refrescante y matices especiados.",
    visualColor: "linear-gradient(135deg, #4A154B 0%, #10B981 100%)",
    bgPattern: "radial-gradient(circle, rgba(74,21,75,0.2) 0%, transparent 70%)"
  },
  {
    id: "sweet-green-poison-f1",
    image: "img/sweet-green-poison-f1.webp",
    name: "Green Poison F1 Fast",
    aka: "Green Poison F1 Fast Version",
    bank: "Sweet Seeds",
    species: "Índica",
    thc: 20, cbd: 0.4,
    indicaPct: 70, sativaPct: 30,
    yieldIndoor: 550, yieldOutdoor: 650,
    floweringDays: 42, rating: 4.9, reviewsCount: 840,
    genetics: "Green Poison x Sweet Special Auto (F1 Fast Version fotoperiódica)",
    lineage: "Green Poison x Sweet Special Auto (F1 Fast Version fotoperiódica)",
    origin: "España",
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 45, caryophyllene: 30, limonene: 25 },
    aroma: "Fruta dulce madura, fondo floral skunky y notas terrosas",
    flavors: ["Fruta Madura", "Skunk Floral", "Fondo Terroso"],
    effects: ["Relajación Corporal Rápida", "Euforia Equilibrada", "Bienestar Físico"],
    activities: ["relax_sleep", "social", "nature_walk"],
    description: "Versión fotoperiódica feminizada de floración ultrarrápida (6 semanas) de una de las genéticas más premiadas de Sweet Seeds. Green Poison F1 Fast Version ofrece una producción colosal de flores compactas colmadas de resina aromática con un dulzor afrutado inconfundible y gran resistencia en exteriores.",
    visualColor: "linear-gradient(135deg, #059669 0%, #D97706 100%)",
    bgPattern: "radial-gradient(circle, rgba(5,150,105,0.2) 0%, transparent 70%)"
  },
  {
    id: "sensi-silver-haze",
    image: "img/sensi-silver-haze.webp",
    name: "Silver Haze",
    aka: "Silver Pearl x Haze",
    bank: "Sensi Seeds",
    species: "Sativa",
    thc: 22, cbd: 0.2,
    indicaPct: 25, sativaPct: 75,
    yieldIndoor: 500, yieldOutdoor: 650,
    floweringDays: 70, rating: 4.9, reviewsCount: 1560,
    genetics: "Silver Pearl x Haze",
    lineage: "Silver Pearl x Haze",
    origin: "Ámsterdam, Países Bajos",
    dominantTerpene: "terpinolene",
    terpenes: { terpinolene: 45, myrcene: 30, caryophyllene: 25 },
    aroma: "Incienso Haze clásico, madera de pino y pimienta blanca",
    flavors: ["Incienso Haze", "Pino Fresco", "Pimienta Especiada"],
    effects: ["Euforia Cerebral Intensa", "Claridad Mental", "Energía Creativa"],
    activities: ["creativity", "social", "nature_walk"],
    description: "La legendaria Silver Haze de Sensi Seeds revolucionó el cultivo de sativas en interior al acortar la larguísima floración de la Haze original mediante el cruce con Northern Lights y Silver Pearl. Sus racimos florales alargados parecen bañados en plata pura por su inmensa cobertura de glándulas de resina brillante.",
    visualColor: "linear-gradient(135deg, #E5E7EB 0%, #10B981 100%)",
    bgPattern: "radial-gradient(circle, rgba(229,231,235,0.2) 0%, transparent 70%)"
  },
  {
    id: "dna-kandy-kush",
    image: "img/dna-kandy-kush.webp",
    name: "Kandy Kush",
    aka: "OG Kush x Trainwreck",
    bank: "DNA Genetics",
    species: "Índica",
    thc: 22, cbd: 0.2,
    indicaPct: 60, sativaPct: 40,
    ...
    dominantTerpene: "limonene",
    terpenes: { limonene: 40, myrcene: 35, caryophyllene: 25 },
    aroma: "Kush dulce acaramelado, limón cítrico y fondo diésel",
    flavors: ["Kush Acaramelado", "Limón Intenso", "Combustible Diésel"],
    effects: ["Alivio Físico Duradero", "Relajación Calmante", "Euforia Placentera"],
    activities: ["relax_sleep", "gaming", "music"],
    description: "Kandy Kush de DNA Genetics (Reserva Privada) une la potencia legendaria de la OG Kush de California con la vigorosidad y producción aromática de Trainwreck. Múltiples veces galardonada en copas cannábicas internacionales, es famosa por sus colas resinosas con un sabor dulce como caramelo de limón.",
    visualColor: "linear-gradient(135deg, #F59E0B 0%, #10B981 100%)",
    bgPattern: "radial-gradient(circle, rgba(245,158,11,0.2) 0%, transparent 70%)"
  },
  {
    id: "ripper-chempie",
    image: "img/ripper-chempie.webp",
    name: "Chempie",
    aka: "Cherry Pie x Chemdawg",
    bank: "Ripper Seeds",
    species: "Híbrida",
    thc: 26, cbd: 0.1,
    indicaPct: 60, sativaPct: 40,
    yieldIndoor: 550, yieldOutdoor: 700,
    floweringDays: 60, rating: 4.9, reviewsCount: 780,
    genetics: "Cherry Pie x Chemdawg",
    lineage: "Cherry Pie x Chemdawg",
    origin: "España",
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 42, limonene: 33, myrcene: 25 },
    aroma: "Pastel de cereza, combustible químico picante y frutas silvestres",
    flavors: ["Pastel de Cereza", "Gasolina Picante", "Frutas Rojas"],
    effects: ["Potencia Psicodélica", "Relajación Muscular", "Estimulación Sensorial"],
    activities: ["creativity", "gaming", "music"],
    description: "Chempie es una de las creaciones más aclamadas de Ripper Seeds, nacida del cruce de Cherry Pie con un clon élite de Chemdawg. Destaca por su producción abrumadora de tricomas cabeza-tallo, cálices carnosos y un perfil organoléptico complejo que combina frutas rojas maduras con un potente fondo químico.",
    visualColor: "linear-gradient(135deg, #991B1B 0%, #10B981 100%)",
    bgPattern: "radial-gradient(circle, rgba(153,27,27,0.2) 0%, transparent 70%)"
  }
,
  {
    id: "silent-polar-gelato",
    genetics: "Bacio Gelato x Sunset Sherbet (Sherbinskis)",
    lineage: "Bacio Gelato x Sunset Sherbet",
    name: "Polar Gelato",
    bank: "Silent Seeds",
    species: "Híbrida",
    thc: 30,
    ...
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 45, limonene: 35, myrcene: 20 },
    flavors: ["Galleta Dulce", "Helado Floral", "Gasolina Cremosa"],
    effects: ["Potencia Polar", "Euforia Cerebral", "Paz Corporal"],
    activities: ["relax_sleep", "creativity", "cinema"],
    description: "Obra maestra de la colección exclusiva con Mario Guzman (Sherbinskis). Cruce auténtico de Bacio Gelato x Sunset Sherbert que alcanza hasta un astronómico 30% de THC. Su perfil aromático fusiona notas de postre helado italiano con matices florales dulces y un fondo kushy de alta intensidad.",
    image: "img/silent-polar-gelato.webp",
    visualColor: "linear-gradient(135deg, #0284C7 0%, #38BDF8 100%)",
    bgPattern: "radial-gradient(circle, rgba(56,189,248,0.2) 0%, transparent 70%)"
  },
  {
    id: "silent-pink-sunset",
    genetics: "Sunset Sherbet x Florida OG (Sherbinskis)",
    lineage: "Sunset Sherbet x Florida OG",
    name: "Pink Sunset",
    bank: "Silent Seeds",
    species: "Índica",
    thc: 24,
    ...
    sativaPct: 35,
    dominantTerpene: "limonene",
    terpenes: { limonene: 40, linalool: 35, myrcene: 25 },
    flavors: ["Fruta Helada", "Cítrico Dulce", "Postre Cremoso"],
    effects: ["Atardecer Sereno", "Dicha Flotante", "Desconexión Total"],
    activities: ["meditation", "relax_sleep", "nature_walk"],
    description: "Joyel botánico desarrollado mano a mano con Sherbinskis a partir del cruce Sunset Sherbert x Florida OG. Célebre por sus cálices que viran a tonos púrpuras y rosáceos durante la maduración y su aroma a sorbete de frutas confitadas con fondo dulce y floral.",
    image: "img/silent-pink-sunset.webp",
    visualColor: "linear-gradient(135deg, #EC4899 0%, #F43F5E 100%)",
    bgPattern: "radial-gradient(circle, rgba(244,63,94,0.2) 0%, transparent 70%)"
  },
  {
    id: "silent-b-45",
    genetics: "Florida OG x Pre'98 Bubba Kush (Koba LaD)",
    lineage: "Florida OG x Pre'98 Bubba Kush",
    name: "B-45",
    bank: "Silent Seeds",
    species: "Híbrida",
    thc: 32,
    ...
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 45, caryophyllene: 35, limonene: 20 },
    flavors: ["Naranja Cítrica", "Pastel Dulce", "Combustible Kush"],
    effects: ["Despegue Tornado", "Poder Explosivo", "Inercia Psicoactiva"],
    activities: ["gaming", "music", "creativity"],
    description: "Creación histórica desarrollada en colaboración con el célebre rapero francés Booba. Cruce complejo de (Florida OG x Pre'98 Bubba Kush) x Orange Punch #66 que supera el 30-32% de THC verificado en laboratorio. Cogollos petrificados con aroma a naranja confitada y fuel denso.",
    image: "img/silent-b-45.webp",
    visualColor: "linear-gradient(135deg, #EA580C 0%, #D97706 100%)",
    bgPattern: "radial-gradient(circle, rgba(234,88,12,0.2) 0%, transparent 70%)"
  },
  {
    id: "silent-acai-jelly",
    genetics: "Acai Berry Gelato x Bacio Gelato (Sherbinskis)",
    lineage: "Acai Berry Gelato x Bacio Gelato",
    name: "Acai Jelly",
    bank: "Silent Seeds",
    species: "Híbrida",
    thc: 28,
    ...
    sativaPct: 40,
    dominantTerpene: "linalool",
    terpenes: { linalool: 40, caryophyllene: 35, limonene: 25 },
    flavors: ["Mermelada Açai", "Cacao Frutal", "Kush Terroso"],
    effects: ["Euforia Aterciopelada", "Gozo Sensorial", "Paz Prolongada"],
    activities: ["creativity", "social", "cinema"],
    description: "Fruto de la hibridación de dos parentales élite californianos: Acai Berry Gelato x Bacio Gelato. Ofrece un bouquet de confitura de frutos del bosque, bayas de açai y crema pastelera sobre un lecho de tricomas densamente compactados.",
    image: "img/silent-acai-jelly.webp",
    visualColor: "linear-gradient(135deg, #7C3AED 0%, #A855F7 100%)",
    bgPattern: "radial-gradient(circle, rgba(124,58,237,0.2) 0%, transparent 70%)"
  },
  {
    id: "silent-watermelon-runtz",
    genetics: "Watermelon Zkittlez x Runtz",
    lineage: "Watermelon Zkittlez x Runtz",
    name: "Watermelon Runtz",
    bank: "Silent Seeds",
    species: "Índica",
    thc: 26,
    cbd: 0.2,
    ...
    dominantTerpene: "limonene",
    terpenes: { limonene: 50, myrcene: 30, caryophyllene: 20 },
    flavors: ["Sandía Tropical", "Golosina Ácida", "Fruta Madura"],
    effects: ["Delicia Sonriente", "Relax Muscular", "Calma Serena"],
    activities: ["relax_sleep", "gaming", "social"],
    description: "Fusión dulce por excelencia que une Watermelon Zkittlez y la célebre Runtz. Espectáculo visual con racimos florales teñidos de violeta y un perfil de terpenos que evoca rodajas de sandía jugosa combinadas con caramelos masticables.",
    image: "img/silent-watermelon-runtz.webp",
    visualColor: "linear-gradient(135deg, #10B981 0%, #F43F5E 100%)",
    bgPattern: "radial-gradient(circle, rgba(244,63,94,0.2) 0%, transparent 70%)"
  },
  {
    id: "silent-cookielato",
    ...
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 40, limonene: 35, myrcene: 25 },
    flavors: ["Masa de Galleta", "Lavanda Floral", "Fruta Exótica"],
    effects: ["Placer Gastronómico", "Serenidad Mental", "Efecto Pesado"],
    activities: ["relax_sleep", "cinema", "meditation"],
    description: "Cruce élite de dos leyendas californianas: Gelato #41 x Do-Si-Dos. Estructura compacta de cogollos rocosos envueltos en cálices resinosos y un perfil aromático dulce y horneado que combina masa de galletas con notas florales y frutales.",
    image: "img/silent-cookielato.webp",
    visualColor: "linear-gradient(135deg, #D97706 0%, #78350F 100%)",
    bgPattern: "radial-gradient(circle, rgba(217,119,6,0.2) 0%, transparent 70%)"
  },
  {
    id: "silent-la-vanilla-cake",
    genetics: "Ice Cream Cake x Wedding Cake",
    lineage: "Ice Cream Cake x Wedding Cake",
    ...
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 45, caryophyllene: 30, limonene: 25 },
    flavors: ["Vainilla Bourbon", "Tarta Horneada", "Merengue Dulce"],
    effects: ["Gusto Gourmet", "Alivio Profundo", "Sedación Plácida"],
    activities: ["relax_sleep", "meditation", "cinema"],
    description: "Híbrido de alta repostería cannábica que cruza Ice Cream Cake con Wedding Cake. Desarrolla flores prietas como piedras, con cálices rebosantes de glándulas resinosas y un sabor cremoso inconfundible a pastel de vainilla de Madagascar.",
    image: "img/silent-la-vanilla-cake.webp",
    visualColor: "linear-gradient(135deg, #FDE047 0%, #CA8A04 100%)",
    bgPattern: "radial-gradient(circle, rgba(202,138,4,0.2) 0%, transparent 70%)"
  },
  {
    id: "silent-critical-plus-2",
    genetics: "Critical + x Critical + (Dinafem Original)",
    lineage: "Critical + x Critical +",
    name: "Critical + 2.0",
    bank: "Silent Seeds",
    species: "Índica",
    thc: 20,
    ...
    dominantTerpene: "pinene",
    terpenes: { pinene: 40, myrcene: 35, caryophyllene: 25 },
    flavors: ["Skunk Cítrico", "Pino Silvestre", "Limón Intenso"],
    effects: ["Efecto Relámpago", "Relajación Corporal", "Optimismo Cálido"],
    activities: ["social", "relax_sleep", "nature_walk"],
    description: "La auténtica y legítima sucesora de Critical + de Dinafem Seeds conservada por el equipo original en Silent Seeds. Famosa mundialmente por su rapidez de floración de tan solo 45-50 días, cosechas colosales y su penetrante olor a Skunk apestoso y limón maduro.",
    image: "img/silent-critical-plus-2.webp",
    visualColor: "linear-gradient(135deg, #16A34A 0%, #15803D 100%)",
    bgPattern: "radial-gradient(circle, rgba(22,163,74,0.2) 0%, transparent 70%)"
  },
  {
    id: "silent-critical-jack",
    genetics: "Critical + x Jack Herer (Dinafem Original)",
    lineage: "Critical + x Jack Herer",
    name: "Critical Jack",
    bank: "Silent Seeds",
    species: "Sativa",
    thc: 21,
    ...
    flavors: ["Incienso Catedral", "Maderas Nobles", "Cítrico Especiado"],
    effects: ["Claridad Activa", "Chispa Cognitiva", "Euforia Limpia"],
    activities: ["creativity", "nature_walk", "gaming"],
    description: "El clásico eterno entre Critical + y Jack Herer rescatado en su máxima expresión por Silent Seeds. Híbrido vigoroso de colas centrales interminables, caracterizado por su aroma catedralicio a incienso Haze, madera de cedro y cáscara de cítricos.",
    image: "img/silent-critical-jack.webp",
    visualColor: "linear-gradient(135deg, #F59E0B 0%, #10B981 100%)",
    bgPattern: "radial-gradient(circle, rgba(245,158,11,0.2) 0%, transparent 70%)"
  },
  {
    id: "silent-starfire-og",
    genetics: "Starfire OG x Fire OG",
    lineage: "Starfire OG x Fire OG",
    name: "Starfire OG",
    bank: "Silent Seeds",
    species: "Índica",
    thc: 28,
    ...
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 50, caryophyllene: 30, limonene: 20 },
    flavors: ["Gasolina Pura", "Pino Intenso", "Química Diesel"],
    effects: ["Impacto OG Pesado", "Relajación Muscular", "Paz Nocturna"],
    activities: ["relax_sleep", "meditation", "cinema"],
    description: "Una de las variedades más galardonadas de la línea OG de Silent Seeds. Cruce de Starfire Chem y Fire OG BX3 que produce una concentración abrumadora de resina gomosa con un inconfundible aroma a combustible diésel, pino mojado y tierra química.",
    image: "img/silent-starfire-og.webp",
    visualColor: "linear-gradient(135deg, #047857 0%, #065F46 100%)",
    bgPattern: "radial-gradient(circle, rgba(4,120,87,0.2) 0%, transparent 70%)"
  }
,
  {
    ...
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 45, limonene: 35, myrcene: 20 },
    flavors: ["Piña Madura", "Mango Dulce", "Cítrico Resinoso"],
    effects: ["Potencia Psicodélica", "Euforia Cósmica", "Relajación Profunda"],
    activities: ["creativity", "deep_conversation", "listening_music"],
    description: "Legendaria creación de Anesia Seeds que rompió récords mundiales alcanzando hasta un astronómico 37% de THC. Nacida del cruce entre Starfighter y Original Glue (GG#4), genera densos racimos florales saturados de glándulas de resina con intensos aromas a piña, mango maduro y matices cítricos.",
    image: "img/anesia-future-1.webp",
    visualColor: "linear-gradient(135deg, #10B981 0%, #065F46 100%)",
    bgPattern: "radial-gradient(circle, rgba(16,185,129,0.2) 0%, transparent 70%)"
  },
  {
    id: "anesia-blackberry-moonrocks",
    genetics: "Blue Moonrock x Blackberry Kush",
    lineage: "Blue Moonrock x Blackberry Kush",
    ...
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 50, caryophyllene: 30, linalool: 20 },
    flavors: ["Moras Silvestres", "Arándano Dulce", "Lavanda Terrosa"],
    effects: ["Paz Absoluta", "Sedación Plácida", "Éxtasis Físico"],
    activities: ["relax_sleep", "meditation", "stargazing"],
    description: "Cepa índica dominante ultra potente con un contenido de THC de hasta el 33%. Produce cogollos duros como rocas de tonalidades púrpuras y azuladas, completamente escarchados de tricomas y con un bouquet delicioso a moras silvestres maduras y arándanos con fondo floral.",
    image: "img/anesia-blackberry-moonrocks.webp",
    visualColor: "linear-gradient(135deg, #7C3AED 0%, #4C1D95 100%)",
    bgPattern: "radial-gradient(circle, rgba(124,58,237,0.2) 0%, transparent 70%)"
  },
  {
    id: "anesia-frozen-black-cherry",
    genetics: "Pacific Frost x Blackberry Moonrocks",
    lineage: "Pacific Frost x Blackberry Moonrocks",
    name: "Frozen Black Cherry",
    bank: "Anesia Seeds",
    species: "Índica",
    thc: 35,
    cbd: 0.1,
    ...
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 45, limonene: 35, myrcene: 20 },
    flavors: ["Cereza Helada", "Baya Dulce", "Uva Cremosa"],
    effects: ["Relajación Glacial", "Dicha Flotante", "Desconexión Mental"],
    activities: ["cinema", "relax_sleep", "reading"],
    description: "Supervariedad con niveles descomunales de THC de hasta el 35%. Espectacular cruce entre Blackberry Moonrocks y Pacific Frost que entrega flores cubiertas por una capa de resina blanca escarchada semejante a la nieve sobre cálices oscuros, aromatizados con dulces cerezas negras maduras y toques de bayas silvestres.",
    image: "img/anesia-frozen-black-cherry.webp",
    visualColor: "linear-gradient(135deg, #991B1B 0%, #450A0A 100%)",
    bgPattern: "radial-gradient(circle, rgba(153,27,27,0.2) 0%, transparent 70%)"
  },
  {
    id: "anesia-captain-future",
    genetics: "Future #1 x Emperor Cookies",
    lineage: "Future #1 x Emperor Cookies",
    name: "Captain Future",
    bank: "Anesia Seeds",
    species: "Sativa",
    thc: 36,
    ...
    dominantTerpene: "terpinolene",
    terpenes: { terpinolene: 45, limonene: 35, pinene: 20 },
    flavors: ["Piña Ácida", "Cítrico Punzante", "Galleta Dulce"],
    effects: ["Energía Electrizante", "Claridad Mental", "Euforia Motivacional"],
    activities: ["sports", "creativity", "social_events"],
    description: "Monstruo sativo de potencia deslumbrante que alcanza hasta el 36% de THC. Desarrollada cruzando Future #1 con Emperor Cookies, estimula intensamente la creatividad y la energía cerebral mientras despliega aromas intensos a piña ácida, frutas tropicales y toques dulces de repostería.",
    image: "img/anesia-captain-future.webp",
    visualColor: "linear-gradient(135deg, #F59E0B 0%, #B45309 100%)",
    bgPattern: "radial-gradient(circle, rgba(245,158,11,0.2) 0%, transparent 70%)"
  },
  {
    id: "anesia-banana-mac",
    genetics: "MAC x Banana Kush",
    lineage: "MAC x Banana Kush",
    name: "Banana MAC",
    bank: "Anesia Seeds",
    species: "Híbrida",
    thc: 26,
    ...
    dominantTerpene: "limonene",
    terpenes: { limonene: 45, caryophyllene: 30, myrcene: 25 },
    flavors: ["Plátano Maduro", "Masa Dulce", "Crema Vainillada"],
    effects: ["Bienestar Equilibrado", "Risas y Euforia", "Calma Corporal"],
    activities: ["cooking", "video_games", "social_events"],
    description: "Combinación sublime entre la famosa Miracle Alien Cookies (MAC) y una seleccionada Banana Kush. Presenta flores carnosas cargadas de tricomas dorados y una sinfonía organoléptica que evoca plátano dulce, masa de galleta recién horneada y matices cremosos aterciopelados.",
    image: "img/anesia-banana-mac.webp",
    visualColor: "linear-gradient(135deg, #EAB308 0%, #A16207 100%)",
    bgPattern: "radial-gradient(circle, rgba(234,179,8,0.2) 0%, transparent 70%)"
  },
  {
    id: "anesia-nova-og",
    genetics: "Topanga OG x Blackberry Kush",
    lineage: "Topanga OG x Blackberry Kush",
    name: "Nova OG",
    bank: "Anesia Seeds",
    species: "Índica",
    thc: 32,
    ...
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 50, myrcene: 30, limonene: 20 },
    flavors: ["Café Tostado", "Limón Confitado", "Pino Terroso"],
    effects: ["Anestesia Corporal", "Paz Mental Inquebrantable", "Alivio Profundo"],
    activities: ["relax_sleep", "spa_wellness", "meditation"],
    description: "Una de las variedades más contundentes y laureadas del catálogo de Anesia Seeds con hasta un 32% de THC. Destaca por su gruesa capa de resina cristalina, su aroma a café tostado con notas cítricas de limón maduro y pino, y un impacto físico calmante de nivel medicinal.",
    image: "img/anesia-nova-og.webp",
    visualColor: "linear-gradient(135deg, #059669 0%, #064E3B 100%)",
    bgPattern: "radial-gradient(circle, rgba(5,150,105,0.2) 0%, transparent 70%)"
  },
  {
    id: "anesia-big-bazooka",
    genetics: "Big Bud x Jack Herer selección",
    lineage: "Big Bud x Jack Herer",
    name: "Big Bazooka",
    bank: "Anesia Seeds",
    species: "Índica",
    thc: 29,
    ...
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 55, caryophyllene: 25, pinene: 20 },
    flavors: ["Limón Dulce", "Resina Aromática", "Toque Especiado"],
    effects: ["Pesadez Corporal", "Calma Placentera", "Sueño Reparador"],
    activities: ["relax_sleep", "cinema", "stargazing"],
    description: "Superproductora masiva de cogollos pesados como cañones creada a partir del cruce de Big Bud y Jack Herer. Con un 29% de THC y rendimientos de hasta 800 g/m² en interior, ofrece un efecto índico sedante fulminante con fragancias a limón azucarado y resina clásica.",
    image: "img/anesia-big-bazooka.webp",
    visualColor: "linear-gradient(135deg, #84CC16 0%, #4D7C0F 100%)",
    bgPattern: "radial-gradient(circle, rgba(132,204,22,0.2) 0%, transparent 70%)"
  },
  {
    id: "anesia-slurricane",
    genetics: "Do-Si-Dos x Purple Punch",
    ...
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 40, myrcene: 35, limonene: 25 },
    flavors: ["Frutas del Bosque", "Uva Dulce", "Especias Suaves"],
    effects: ["Bienestar Corporal", "Euforia Relajante", "Anti-Estrés"],
    activities: ["dinner_party", "cinema", "nature_walk"],
    description: "Genética estelar desarrollada a partir de Do-Si-Dos y Purple Punch que alcanza un 30% de THC. Famosa por sus colores morados profundos, exuberante densidad de tricomas y un perfil de terpenos rico en uvas dulces, bayas maduras y matices cremosos.",
    image: "img/anesia-slurricane.webp",
    visualColor: "linear-gradient(135deg, #6D28D9 0%, #4338CA 100%)",
    bgPattern: "radial-gradient(circle, rgba(109,40,217,0.2) 0%, transparent 70%)"
  },
  {
    id: "anesia-apricot-oreoz",
    genetics: "Apricot Jelly x Oreoz",
    lineage: "Apricot Jelly x Oreoz",
    name: "Apricot Oreoz",
    bank: "Anesia Seeds",
    species: "Híbrida",
    thc: 33,
    ...
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 45, caryophyllene: 30, limonene: 25 },
    flavors: ["Albaricoque Dulce", "Chocolate Suave", "Vainilla Cremosa"],
    effects: ["Euforia Hedonista", "Calma Mental", "Bienestar Físico"],
    activities: ["creativity", "cooking", "listening_music"],
    description: "Exclusiva joya aromática fruto de la unión entre Apricot Jelly y Oreoz con un impresionante 33% de THC. Ofrece una experiencia gustativa única que fusiona albaricoques dulces recién recolectados, chocolate suave y galletas con crema, bajo un manto resinoso impenetrable.",
    image: "img/anesia-apricot-oreoz.webp",
    visualColor: "linear-gradient(135deg, #F97316 0%, #C2410C 100%)",
    bgPattern: "radial-gradient(circle, rgba(249,115,22,0.2) 0%, transparent 70%)"
  },
  {
    id: "anesia-imperium-x",
    genetics: "City of God x The White Angel x Future #1",
    lineage: "City of God x White Angel x Future #1",
    name: "Imperium X",
    bank: "Anesia Seeds",
    species: "Híbrida",
    thc: 36,
    ...
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 45, limonene: 35, myrcene: 20 },
    flavors: ["Piña Dulce", "Sándalo Especiado", "Uvas Maduras"],
    effects: ["Gravedad Cero", "Euforia Expansiva", "Paz Hipnótica"],
    activities: ["deep_conversation", "stargazing", "listening_music"],
    description: "Una de las cepas más potentes del planeta, alcanzando un colosal 36% de THC. Nacida de un triple cruce magistral entre City of God, The White y Future #1, cautiva con flores de tonos morados oscuros casi negros cubiertas por una coraza cristalina de tricomas y un bouquet complejo a frutas dulces y sándalo.",
    image: "img/anesia-imperium-x.webp",
    visualColor: "linear-gradient(135deg, #4A044E 0%, #1E1B4B 100%)",
    bgPattern: "radial-gradient(circle, rgba(74,4,78,0.2) 0%, transparent 70%)"
  }
,
  {
    id: "rare-ghost-train-haze-1",
    genetics: "Ghost OG x Nevil's Wreck",
    lineage: "Ghost OG x Nevil's Wreck",
    name: "Ghost Train Haze #1",
    bank: "Rare Dankness",
    species: "Sativa",
    thc: 28,
    cbd: 0.1,
    ...
    flavors: ["Cítrico Agrio", "Pino Silvestre", "Bruma Haze"],
    effects: ["Potencia Cerebral", "Euforia Estimulante", "Chispa Creativa"],
    activities: ["creativity", "listening_music", "nature_walk"],
    description: "La insignia inmortal de Rare Dankness y ganadora de múltiples High Times Cannabis Cups. Cruce entre Ghost OG y Nevil's Wreck que produce flores alargadas cubiertas por una manta densa de tricomas blancos, con un perfil terpénico penetrante a limón ácido, pino dulce y fondo haze catedralicio.",
    image: "img/rare-ghost-train-haze-1.webp",
    visualColor: "linear-gradient(135deg, #EAB308 0%, #854D0E 100%)",
    bgPattern: "radial-gradient(circle, rgba(234,179,8,0.2) 0%, transparent 70%)"
  },
  {
    ...
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 45, caryophyllene: 35, limonene: 20 },
    flavors: ["Limón Kush", "Combustible Diésel", "Tierra Húmeda"],
    effects: ["Anestesia Corporal", "Pesadez Narcótica", "Paz Mental"],
    activities: ["relax_sleep", "cinema", "meditation"],
    description: "Homenaje personal del fundador de Rare Dankness a partir de la cruza de Triangle Kush con Rare Dankness #1. Cepa legendaria que produce flores resinosas de dureza pétrea cargadas de un aroma a limón penetrante con notas a queroseno y tierra mojada.",
    image: "img/rare-scotts-og.webp",
    visualColor: "linear-gradient(135deg, #059669 0%, #064E3B 100%)",
    bgPattern: "radial-gradient(circle, rgba(5,150,105,0.2) 0%, transparent 70%)"
  },
  {
    id: "rare-moonshine-haze",
    genetics: "Amnesia Haze (Soma) x Nevil's Wreck",
    ...
    sativaPct: 70,
    dominantTerpene: "terpinolene",
    terpenes: { terpinolene: 45, pinene: 30, caryophyllene: 25 },
    flavors: ["Frutas Tropicales", "Pino Dulce", "Gominola Cítrica"],
    effects: ["Subidón Extático", "Claridad Mental", "Energía Social"],
    activities: ["social_events", "sports", "creativity"],
    description: "Ganadora del 1er premio a la Mejor Sativa en la High Times Cannabis Cup de Ámsterdam 2011. Cruce entre la vieja Amnesia Haze de Soma y Nevil's Wreck, deleita con una fragancia dulce a ponche de frutas tropicales, pino acaramelado y un viaje mental lúcido y motivador.",
    image: "img/rare-moonshine-haze.webp",
    visualColor: "linear-gradient(135deg, #F59E0B 0%, #D97706 100%)",
    bgPattern: "radial-gradient(circle, rgba(245,158,11,0.2) 0%, transparent 70%)"
  },
  {
    id: "rare-commerce-city-kush",
    genetics: "Chemdawg #4 x Rare Dankness #1",
    lineage: "Chemdawg #4 x RD#1",
    ...
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 45, myrcene: 35, limonene: 20 },
    flavors: ["Queroseno Químico", "Fuel Intenso", "Pino Picante"],
    effects: ["Sedación Knockout", "Alivio Físico Absoluto", "Calma Nocturna"],
    activities: ["relax_sleep", "cinema", "spa_wellness"],
    description: "Híbrido de tremenda contundencia nacido del cruce entre el clon élite Chem 4 y Rare Dankness #1. Ofrece cálices gruesos que exudan una resina grasosa con aroma a hidrocarburos puros, combustible pesado y toques terrosos, ideal para la desconexión total.",
    image: "img/rare-commerce-city-kush.webp",
    visualColor: "linear-gradient(135deg, #0284C7 0%, #0369A1 100%)",
    bgPattern: "radial-gradient(circle, rgba(2,132,199,0.2) 0%, transparent 70%)"
  },
  {
    id: "rare-star-killer",
    genetics: "Skywalker OG Kush x Rare Dankness #2",
    lineage: "Skywalker OG x RD#2",
    name: "Star Killer",
    bank: "Rare Dankness",
    species: "Índica",
    thc: 28,
    ...
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 50, caryophyllene: 30, limonene: 20 },
    flavors: ["Limón Agrio", "Kush Terroso", "Pimienta Dulce"],
    effects: ["Gravedad Cero", "Paz Profunda", "Alivio Muscular"],
    activities: ["relax_sleep", "stargazing", "meditation"],
    description: "Multicampeona galardonada en Colorado (High Times Cannabis Cup y Oregon Grower's Cup). Cruce estelar entre Skywalker OG y Rare Dankness #2 que envuelve al cultivador en una marea de resina densa con notas a limón terroso y especias kush.",
    image: "img/rare-star-killer.webp",
    visualColor: "linear-gradient(135deg, #6366F1 0%, #4338CA 100%)",
    bgPattern: "radial-gradient(circle, rgba(99,102,241,0.2) 0%, transparent 70%)"
  },
  {
    id: "rare-somali-taxi-ride",
    genetics: "Malawi Landrace x Nevil's Wreck",
    lineage: "Malawi x Nevil's Wreck",
    name: "Somali Taxi Ride",
    bank: "Rare Dankness",
    species: "Sativa",
    thc: 26,
    cbd: 0.1,
    ...
    dominantTerpene: "terpinolene",
    terpenes: { terpinolene: 45, limonene: 35, myrcene: 20 },
    flavors: ["Jengibre Picante", "Cítrico Africano", "Floral Especiado"],
    effects: ["Velocidad Mental", "Euforia Eléctrica", "Entusiasmo Activo"],
    activities: ["sports", "social_events", "creativity"],
    description: "Sativa indomable nacida de la combinación entre una potente landrace de Malawi y Nevil's Wreck. Despierta una estimulación mental vertiginosa y duradera mientras llena la boca con un sabor floral especiado, jengibre fresco y cáscara de naranja amarga.",
    image: "img/rare-somali-taxi-ride.webp",
    visualColor: "linear-gradient(135deg, #10B981 0%, #047857 100%)",
    bgPattern: "radial-gradient(circle, rgba(16,185,129,0.2) 0%, transparent 70%)"
  },
  {
    id: "rare-cornbread",
    genetics: "Katsu Bubba Kush x Rare Dankness #2",
    lineage: "Katsu Bubba x RD#2",
    name: "Cornbread",
    bank: "Rare Dankness",
    species: "Índica",
    thc: 25,
    ...
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 45, caryophyllene: 30, linalool: 25 },
    flavors: ["Masa Dulce", "Flores de Azahar", "Kush Cremoso"],
    effects: ["Calidez Corporal", "Sueño Plácido", "Relajación Digestiva"],
    activities: ["relax_sleep", "cinema", "cooking"],
    description: "Deliciosa variedad índica resultante de la polinización del célebre clon Katsu Bubba Kush con Rare Dankness #2. Caracterizada por sus racimos florales compactos como piñas y su complejo aroma a pan dulce recién horneado, flores aromáticas y fondo kush cremoso.",
    image: "img/rare-cornbread.webp",
    visualColor: "linear-gradient(135deg, #D97706 0%, #92400E 100%)",
    bgPattern: "radial-gradient(circle, rgba(217,119,6,0.2) 0%, transparent 70%)"
  },
  {
    id: "rare-darkness",
    genetics: "Grape Ape x Rare Dankness #1",
    lineage: "Grape Ape x RD#1",
    name: "Rare Darkness",
    bank: "Rare Dankness",
    species: "Índica",
    thc: 26,
    ...
    sativaPct: 30,
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 40, myrcene: 35, humulene: 25 },
    flavors: ["Uva Oscura", "Frutos Rojos Maduros", "Lavanda Terrosa"],
    effects: ["Paz Serena", "Meditación Guiada", "Bienestar Físico"],
    activities: ["meditation", "cinema", "relax_sleep"],
    description: "Hermoso cruce entre el clon élite Grape Ape y Rare Dankness #1. Despliega hipnóticos tonos violetas y cálices casi negros cubiertos por una armadura de tricomas plateados, con un sabor delicioso a mosto de uva, bayas oscuras y toques de hachís afgano.",
    image: "img/rare-darkness.webp",
    visualColor: "linear-gradient(135deg, #7C3AED 0%, #4C1D95 100%)",
    bgPattern: "radial-gradient(circle, rgba(124,58,237,0.2) 0%, transparent 70%)"
  },
  {
    id: "rare-walker-kush",
    genetics: "Albert Walker x Rare Dankness #1",
    lineage: "Albert Walker x RD#1",
    name: "Walker Kush",
    bank: "Rare Dankness",
    species: "Híbrida",
    thc: 25,
    ...
    dominantTerpene: "limonene",
    terpenes: { limonene: 45, caryophyllene: 30, myrcene: 25 },
    flavors: ["Mandarina Dulce", "Pino Limonero", "Queroseno Suave"],
    effects: ["Euforia Brillante", "Calma Orgánica", "Chispa Conversacional"],
    activities: ["deep_conversation", "nature_walk", "video_games"],
    description: "Elegante híbrido creado cruzando el legendario clon Albert Walker con Rare Dankness #1. Ofrece una estructura floral aireada pero densamente resinosa con notas embriagadoras a cítricos dulces, cáscara de mandarina madura y un sutil fondo químico.",
    image: "img/rare-walker-kush.webp",
    visualColor: "linear-gradient(135deg, #F97316 0%, #C2410C 100%)",
    bgPattern: "radial-gradient(circle, rgba(249,115,22,0.2) 0%, transparent 70%)"
  },
  {
    ...
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 45, myrcene: 35, limonene: 20 },
    flavors: ["Pino Diésel", "Mora Silvestre", "Tierra Especiada"],
    effects: ["Sedación Total", "Éxtasis Muscular", "Descanso Imperturbable"],
    activities: ["relax_sleep", "meditation", "stargazing"],
    description: "Híbrido de potencia descomunal creado a partir de Skywalker OG y Rare Dankness #1. Desarrolla cálices morados rebosantes de glándulas resinosas que despiden un aroma clásico a pino, combustible diésel y toques dulces a frutas oscuras.",
    image: "img/rare-501st-og.webp",
    visualColor: "linear-gradient(135deg, #1E1B4B 0%, #312E81 100%)",
    bgPattern: "radial-gradient(circle, rgba(49,46,129,0.2) 0%, transparent 70%)"
  },
  // ==========================================
  // BROTHERS GRIMM SEEDS (50º BANCO OFICIAL)
  // Fundado por MrSoul (Rick Campanella) en Colorado, EE.UU.
  // Creadores legendarios de Cinderella 99, Rosetta Stone, Apollo 11
  // 100% Fotoperiódicas de Élite Botánica
  // ==========================================
  {
    id: "bg-cinderella-99",
    genetics: "Jack Herer (Princess clone) x Shiva Skunk",
    lineage: "Jack Herer x Shiva Skunk",
    name: "Cinderella 99",
    bank: "Brothers Grimm Seeds",
    species: "Sativa",
    thc: 22,
    cbd: 0.2,
    floweringDays: 56,
    ...
    sativaPct: 85,
    dominantTerpene: "terpinolene",
    terpenes: { terpinolene: 40, myrcene: 30, caryophyllene: 18, limonene: 12 },
    flavors: ["Piña Madura", "Pomelo Dulce", "Cítrico Tropical", "Toque Especiado"],
    effects: ["Euforia Lúcida", "Creatividad Desbordante", "Energía Social", "Bienestar Cerebral"],
    activities: ["creative", "social", "gaming", "music"],
    description: "La legendaria 'Holy Grail' de MrSoul (Brothers Grimm). Criada meticulosamente a partir de una semilla encontrada en un cogollo de Jack Herer de Sensi Seeds en Ámsterdam (Princess). Famosa a nivel mundial por su tiempo de floración hiper-rápido de apenas 50-56 días para una sativa pura, un perfil aromático irresistible de piña tropical dulce y un efecto eufórico, diáfano y sin pesadez.",
    image: "img/bg-cinderella-99.webp",
    visualColor: "linear-gradient(135deg, #F59E0B 0%, #10B981 100%)",
    bgPattern: "radial-gradient(circle, rgba(245,158,11,0.2) 0%, transparent 70%)"
  },
  {
    id: "bg-rosetta-stone",
    genetics: "Jack Herer x Princess 75",
    lineage: "Jack Herer x Princess 75",
    name: "Rosetta Stone",
    bank: "Brothers Grimm Seeds",
    species: "Híbrida",
    thc: 23,
    ...
    sativaPct: 60,
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 35, pinene: 30, caryophyllene: 20, terpinolene: 15 },
    flavors: ["Incienso Especiado", "Pino Fresco", "Fruta Madura", "Almizcle"],
    effects: ["Estimulación Mental", "Relajación Muscular", "Claridad Positiva", "Inspiración"],
    activities: ["creative", "outdoor_active", "social", "music"],
    description: "Híbrido insignia creado por MrSoul cruzando el legendario clon élite de Jack Herer con el parental macho Princess 75. Rosetta Stone produce colas macizas cubiertas de glándulas de resina cristalina, con una fragancia clásica de incienso especiado y pino dulce, brindando un colocón balanceado, cerebral y sumamente estimulante para los sentidos.",
    image: "img/bg-rosetta-stone.webp",
    visualColor: "linear-gradient(135deg, #8B5CF6 0%, #10B981 100%)",
    bgPattern: "radial-gradient(circle, rgba(139,92,246,0.2) 0%, transparent 70%)"
  },
  {
    id: "bg-apollo-11",
    genetics: "Genius clone x Cinderella 99",
    lineage: "Genius x Cinderella 99",
    name: "Apollo 11",
    bank: "Brothers Grimm Seeds",
    species: "Sativa",
    thc: 21,
    ...
    sativaPct: 80,
    dominantTerpene: "terpinolene",
    terpenes: { terpinolene: 38, limonene: 32, pinene: 18, caryophyllene: 12 },
    flavors: ["Limón Cítrico", "Combustible Suave", "Fruta Dulce", "Herbal"],
    effects: ["Subidón Cerebral Veloz", "Euforia Motivacional", "Foco Láser", "Energía Diurna"],
    activities: ["creative", "exercise", "gaming", "social"],
    description: "Apollo 11 fue desarrollada por Brothers Grimm cruzando la legendaria madre 'Genius' (un fenotipo de Jack Herer reconocido por su aroma cítrico y claridad mental extrema) con Cinderella 99. Su efecto despega como un cohete espacial: rápido, cerebral, energizante y libre de pesadez o taquicardia, terminando su floración en un récord de 7 a 8 semanas.",
    image: "img/bg-apollo-11.webp",
    visualColor: "linear-gradient(135deg, #3B82F6 0%, #EAB308 100%)",
    bgPattern: "radial-gradient(circle, rgba(59,130,246,0.2) 0%, transparent 70%)"
  },
  {
    id: "bg-killer-queen",
    genetics: "Airborne G13 x Cinderella 99",
    lineage: "Airborne G13 x Cinderella 99",
    name: "Killer Queen",
    bank: "Brothers Grimm Seeds",
    species: "Híbrida",
    thc: 24,
    ...
    sativaPct: 55,
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 35, myrcene: 30, limonene: 22, humulene: 13 },
    flavors: ["Cereza Ácida", "Manzana Dulce", "Hachís Afgano", "Pimienta Negra"],
    effects: ["Relajación Profunda", "Paz Mental", "Alivio Físico Intenso", "Euforia Seratónica"],
    activities: ["relax_sleep", "meditation", "music", "cinema"],
    description: "Una colaboración histórica concebida por Vic High de BCGA y MrSoul de Brothers Grimm. Cruza el clon mítico Airborne G13 con el polen de Cinderella 99. Destaca por cogollos macizos con matices de cereza ácida y ponche de frutas sobre un fondo amaderado y especiado de hachís de la vieja escuela, proporcionando una potencia medicinal sobresaliente.",
    image: "img/bg-killer-queen.webp",
    visualColor: "linear-gradient(135deg, #DC2626 0%, #7C3AED 100%)",
    bgPattern: "radial-gradient(circle, rgba(220,38,38,0.2) 0%, transparent 70%)"
  },
  {
    id: "bg-princess-haze",
    genetics: "Princess (Jack Herer) x Super Silver Haze",
    lineage: "Princess x Super Silver Haze",
    name: "Princess Haze",
    bank: "Brothers Grimm Seeds",
    species: "Sativa",
    thc: 23,
    ...
    sativaPct: 75,
    dominantTerpene: "terpinolene",
    terpenes: { terpinolene: 42, myrcene: 25, pinene: 20, limonene: 13 },
    flavors: ["Incienso Tropical", "Pino Resinoso", "Piña Dulce", "Cedro Especiado"],
    effects: ["Euforia Elevada", "Expansión Creativa", "Sensación Ondulante", "Lucidez Activa"],
    activities: ["creative", "outdoor_active", "social", "music"],
    description: "Cruza la madre original de Cinderella 99 ('Princess') con un portentoso macho de Super Silver Haze. El resultado es una combinación hipnótica de sabores tropicales afrutados de C99 con la clásica complejidad haze inciensada. Produce cálices voluminosos cubiertos de cristales plateados y flores de una arquitectura aireada pero sumamente resinosa.",
    image: "img/bg-princess-haze.webp",
    visualColor: "linear-gradient(135deg, #A855F7 0%, #06B6D4 100%)",
    bgPattern: "radial-gradient(circle, rgba(168,85,247,0.2) 0%, transparent 70%)"
  },
  {
    id: "bg-queen-of-soul",
    genetics: "Northern Lights #5 x Cinderella 99",
    lineage: "NL#5 x C99",
    name: "Queen of Soul",
    bank: "Brothers Grimm Seeds",
    species: "Sativa",
    ...
    sativaPct: 75,
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 38, pinene: 28, caryophyllene: 18, limonene: 16 },
    flavors: ["Mango Maduro", "Papaya Tropical", "Especias Exóticas", "Toque Anisado"],
    effects: ["Euforia Luminosa", "Inspiración Artística", "Felicidad Profunda", "Vitalidad Sostenida"],
    activities: ["creative", "music", "nature_walk", "conversation"],
    description: "Una obra maestra de crianza genética de MrSoul que concentra 3 generaciones sucesivas de retrocruces de Princess combinados con la legendaria línea NL#5 x Haze. Queen of Soul es conocida por sus flores colosales con forma de lanza, su embriagador aroma a frutas tropicales maduras con matices de mango y especias asiáticas, y un colocón sativa radiante y sin paranoia.",
    image: "img/bg-queen-of-soul.webp",
    visualColor: "linear-gradient(135deg, #F59E0B 0%, #8B5CF6 100%)",
    bgPattern: "radial-gradient(circle, rgba(245,158,11,0.2) 0%, transparent 70%)"
  },
  {
    id: "bg-grimm-glue",
    genetics: "Gorilla Glue #4 x Cinderella 99",
    lineage: "GG4 x C99",
    name: "Grimm Glue",
    bank: "Brothers Grimm Seeds",
    species: "Híbrida",
    ...
    sativaPct: 50,
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 45, myrcene: 28, limonene: 15, humulene: 12 },
    flavors: ["Diésel Intenso", "Pino Fresco", "Pegamento Químico", "Cítrico Ácido"],
    effects: ["Potencia Arrolladora", "Sedación Placentera", "Euforia Pesada", "Alivio Total del Dolor"],
    activities: ["relax_sleep", "cinema", "couch_lock", "unwind"],
    description: "Uno de los híbridos más potentes y solicitados de la era moderna de Brothers Grimm. Cruza el clon élite de Gorilla Glue #4 con el vigor y rapidez de Cinderella 99. El resultado exhibe niveles de THC de hasta el 28%, con una producción masiva de tricomas pegajosos como resina epoxi y un bouquet intenso de diésel con pino agrio que noquea cualquier estrés.",
    image: "img/bg-grimm-glue.webp",
    visualColor: "linear-gradient(135deg, #10B981 0%, #374151 100%)",
    bgPattern: "radial-gradient(circle, rgba(16,185,129,0.2) 0%, transparent 70%)"
  },
  {
    id: "bg-durban-thai-c99",
    genetics: "Durban Thai Highflyer x Cinderella 99",
    lineage: "Durban Thai x C99",
    name: "Durban Thai x C99",
    bank: "Brothers Grimm Seeds",
    species: "Sativa",
    thc: 22,
    cbd: 0.2,
    ...
    sativaPct: 85,
    dominantTerpene: "ocimene",
    terpenes: { ocimene: 36, terpinolene: 30, myrcene: 20, pinene: 14 },
    flavors: ["Regaliz / Anís", "Fruta Tropical Dulce", "Especias Orientales", "Herbal"],
    effects: ["Subidón Eléctrico", "Claridad Cristalina", "Euforia Sin Ansiedad", "Dinamismo Mental"],
    activities: ["outdoor_active", "social", "creative", "trekking"],
    description: "Cruce excepcional que une la legendaria madre Durban Thai Highflyer (Durban Poison de Sudáfrica x Sativa Landrace Tailandesa de Super Sativa Seed Club) con Cinderella 99. Famosa por sus aromas exóticos de regaliz anisado y fruta tropical, ofreciendo una experiencia sativa vibrante, eléctrica y muy estimulante para actividades creativas y al aire libre.",
    image: "img/bg-durban-thai-c99.webp",
    visualColor: "linear-gradient(135deg, #06B6D4 0%, #F59E0B 100%)",
    bgPattern: "radial-gradient(circle, rgba(6,182,212,0.2) 0%, transparent 70%)"
  },
  {
    id: "bg-ocifer",
    genetics: "Cap Junky x Rosetta Stone",
    lineage: "Cap Junky x Rosetta Stone",
    name: "Ocifer",
    bank: "Brothers Grimm Seeds",
    species: "Híbrida",
    thc: 29,
    ...
    sativaPct: 40,
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 42, limonene: 30, myrcene: 18, linalool: 10 },
    flavors: ["Gas / Combustible", "Menta Cremosa", "Galleta Horneada", "Incienso Dulce"],
    effects: ["Euforia Cerebral Abrumadora", "Relajación Corporal Pesada", "Sedación Serena", "Paz Mental"],
    activities: ["relax_sleep", "couch_lock", "gaming", "night_smoke"],
    description: "Una de las creaciones modernas más aclamadas de Brothers Grimm. Cruza el demoledor clon Cap Junky (Alien Cookies x Kush Mints #11) de Capulator y Seed Junky con la clásica Rosetta Stone. Ocifer produce cogollos colosales escarchados en cristales de resina blanca con un perfil de terpenos gas cremoso y niveles de THC que rozan el 30%.",
    image: "img/bg-ocifer.webp",
    visualColor: "linear-gradient(135deg, #6366F1 0%, #10B981 100%)",
    bgPattern: "radial-gradient(circle, rgba(99,102,241,0.2) 0%, transparent 70%)"
  },
  {
    id: "bg-genius-juice",
    genetics: "Genius clone x C99 Pineapple",
    lineage: "Genius x C99",
    name: "Genius Juice",
    bank: "Brothers Grimm Seeds",
    species: "Sativa",
    thc: 25,
    ...
    sativaPct: 80,
    dominantTerpene: "limonene",
    terpenes: { limonene: 45, terpinolene: 28, myrcene: 15, pinene: 12 },
    flavors: ["Zumo de Piña", "Naranja Dulce", "Cítrico Efervescente", "Floral Tropical"],
    effects: ["Euforia Chispeante", "Energía Creativa", "Buen Humor Inmediato", "Claridad Mental"],
    activities: ["creative", "social", "music", "morning_routine"],
    description: "Genius Juice es la cúspide de la selección de perfiles terpénicos cítrico-tropicales en Brothers Grimm. Combina el mítico clon 'Genius' con una selección súper dulce de C99 Pineapple. El resultado es una verdadera explosión de zumo de piña y frutas tropicales con un efecto diurno vigorizante, inspirador y 100% fotoperiódico.",
    image: "img/bg-genius-juice.webp",
    visualColor: "linear-gradient(135deg, #FBBF24 0%, #34D399 100%)",
    bgPattern: "radial-gradient(circle, rgba(251,191,36,0.2) 0%, transparent 70%)"
  },
  // ==========================================
  // MANDALA SEEDS (51º BANCO OFICIAL)
  // Fundado en 2004 por Mike & Jasmin en España
  // Pioneros en selección botánica orgánica de genéticas Landrace de altura
  // 100% Fotoperiódicas de Élite Botánica
  // ==========================================
  {
    id: "mandala-satori",
    ...
    indicaPct: 15,
    sativaPct: 85,
    genetics: "Nepal Landrace Sativa (Selección Autóctona)",
    lineage: "Nepal Landrace Sativa (Selección Autóctona)",
    dominantTerpene: "terpinolene",
    terpenes: { terpinolene: 42, myrcene: 25, pinene: 20, caryophyllene: 13 },
    flavors: ["Especias Terrosas", "Pimienta Dulce", "Cítrico Sutil", "Incienso Nepalí"],
    effects: ["Claridad Mental", "Euforia Inspiradora", "Concentración Profunda", "Creatividad Trascendente"],
    activities: ["creative", "focus", "meditation", "music"],
    description: "Cepa insignia legendaria de Mandala Seeds (High Times Strain of the Year 2007). Desarrollada a partir de selectas genéticas autóctonas del Nepal por Mike y Jasmin. Satori entrega un colocón lúcido, cerebral y estimulante sin ansiedad ni bajón físico, acompañado de aromas complejos a especias de alta montaña, incienso dulce y pimienta suave.",
    image: "img/mandala-satori.webp",
    visualColor: "linear-gradient(135deg, #10B981 0%, #F59E0B 100%)",
    bgPattern: "radial-gradient(circle, rgba(16,185,129,0.2) 0%, transparent 70%)"
  },
  {
    id: "mandala-hashberry",
    name: "Hashberry",
    bank: "Mandala Seeds",
    species: "Índica",
    thc: 20,
    ...
    indicaPct: 75,
    sativaPct: 25,
    genetics: "North Indian Indica (Kashmir) x Fruity Indica",
    lineage: "North Indian Indica (Kashmir) x Fruity Indica",
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 45, caryophyllene: 25, pinene: 18, humulene: 12 },
    flavors: ["Arándano Silvestre", "Grosella Negra", "Hachís Terroso", "Mora Madura"],
    effects: ["Relajación Corporal", "Tranquilidad Mental", "Efecto Antiestrés", "Bienestar Sedante"],
    activities: ["relax", "sleep", "chill", "movies"],
    description: "Galardonada en el Top 10 del High Times 2006. Hashberry es un cruce selecto de una índica autóctona del norte de la India (valle de Cachemira) con un híbrido afrutado. Desarrolla cogollos duros como rocas con una capa densa de tricomas glandulares y un aroma embriagador a frutos del bosque maduros y hachís tradicional.",
    image: "img/mandala-hashberry.webp",
    visualColor: "linear-gradient(135deg, #8B5CF6 0%, #EC4899 100%)",
    bgPattern: "radial-gradient(circle, rgba(139,92,246,0.2) 0%, transparent 70%)"
  },
  {
    id: "mandala-mandala-1",
    name: "Mandala #1",
    bank: "Mandala Seeds",
    species: "Híbrida",
    thc: 21,
    ...
    indicaPct: 40,
    sativaPct: 60,
    genetics: "South African Highland Sativa x New Zealand Purple Indica",
    lineage: "South African Highland Sativa x New Zealand Purple Indica",
    dominantTerpene: "pinene",
    terpenes: { pinene: 38, myrcene: 28, caryophyllene: 20, limonene: 14 },
    flavors: ["Manzana Dulce", "Madera Noble", "Frutas Silvestres", "Toque Especiado"],
    effects: ["Euforia Cálida", "Relajación Funcional", "Buen Humor", "Bienestar Físico"],
    activities: ["social", "outdoor_active", "creative", "cooking"],
    description: "La campeona de exterior por excelencia de Mandala Seeds, combinando una sativa de altura de Sudáfrica con una índica púrpura de Nueva Zelanda. Destaca por su cosecha extremadamente temprana a finales de septiembre, altísima resistencia al moho y cálices que adquieren tonalidades moradas y rojizas con un perfume afrutado y amaderado.",
    image: "img/mandala-mandala-1.webp",
    visualColor: "linear-gradient(135deg, #EC4899 0%, #3B82F6 100%)",
    bgPattern: "radial-gradient(circle, rgba(236,72,153,0.2) 0%, transparent 70%)"
  },
  {
    id: "mandala-krystalica",
    name: "Krystalica",
    bank: "Mandala Seeds",
    species: "Sativa",
    thc: 23,
    ...
    indicaPct: 25,
    sativaPct: 75,
    genetics: "Satori x Kali China x South Indian Landrace",
    lineage: "Satori x Kali China x South Indian Landrace",
    dominantTerpene: "terpinolene",
    terpenes: { terpinolene: 40, limonene: 28, myrcene: 20, ocimene: 12 },
    flavors: ["Fruta Tropical", "Hierba Luisa", "Manzana Verde", "Piña Dulce"],
    effects: ["Energía Electrizante", "Imaginación Creativa", "Lucidez Extrema", "Subidón Positivo"],
    activities: ["creative", "gaming", "music", "party"],
    description: "Variedad de potencia superlativa creada retrocruzando Satori con genéticas del sur de la India y Kali China. Krystalica produce enormes racimos florales recubiertos por completo de cristales de resina brillantes, ofreciendo un aroma seductor a piña y hierbas cítricas y un colocón expansivo, estimulante y visionario.",
    image: "img/mandala-krystalica.webp",
    visualColor: "linear-gradient(135deg, #06B6D4 0%, #10B981 100%)",
    bgPattern: "radial-gradient(circle, rgba(6,182,212,0.2) 0%, transparent 70%)"
  },
  {
    id: "mandala-8-miles-high",
    name: "8 Miles High",
    bank: "Mandala Seeds",
    species: "Sativa",
    thc: 22,
    ...
    indicaPct: 30,
    sativaPct: 70,
    genetics: "North Indian Landrace (Almora) x African Landrace",
    lineage: "North Indian Landrace (Almora) x African Landrace",
    dominantTerpene: "pinene",
    terpenes: { pinene: 35, caryophyllene: 30, myrcene: 20, terpinolene: 15 },
    flavors: ["Fresa Silvestre", "Pino Fresco", "Menta Alpina", "Hierbas de Montaña"],
    effects: ["Euforia Dinámica", "Activación Mental", "Motivación Pura", "Sensación de Ligereza"],
    activities: ["hiking", "outdoor_active", "social", "creative"],
    description: "Bautizada en honor al legendario himno de The Byrds, este cruce entre una sativa autóctona de las montañas de Almora (norte de la India) y una landrace africana ofrece un subidón rápido, motivador y sumamente social, perfecto para disfrutar de la naturaleza, paseos y actividades al aire libre.",
    image: "img/mandala-8-miles-high.webp",
    visualColor: "linear-gradient(135deg, #F59E0B 0%, #EF4444 100%)",
    bgPattern: "radial-gradient(circle, rgba(245,158,11,0.2) 0%, transparent 70%)"
  },
  {
    id: "mandala-kalichakra",
    name: "Kalichakra",
    bank: "Mandala Seeds",
    species: "Sativa",
    thc: 20,
    ...
    indicaPct: 20,
    sativaPct: 80,
    genetics: "South Indian Landrace (Kerala) x Southeast Asian Sativa",
    lineage: "South Indian Landrace (Kerala) x Southeast Asian Sativa",
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 38, pinene: 27, caryophyllene: 20, limonene: 15 },
    flavors: ["Menta Dulce", "Almizcle Floral", "Incienso Templado", "Madera Sagrada"],
    effects: ["Paz Espiritual", "Inspiración Contemplativa", "Alivio de Tensión", "Claridad Cálida"],
    activities: ["meditation", "yoga", "reading", "music"],
    description: "Nombrada en tributo a la diosa hindú Kali, Kalichakra reúne las mejores características de las sativas tradicionales del estado de Kerala en el sur de la India. Produce lanzas florales robustas, altamente resistentes al estrés y al calor, con una fragancia dulce a menta y almizcle, brindando una experiencia meditativa y serena.",
    image: "img/mandala-kalichakra.webp",
    visualColor: "linear-gradient(135deg, #10B981 0%, #8B5CF6 100%)",
    bgPattern: "radial-gradient(circle, rgba(16,185,129,0.2) 0%, transparent 70%)"
  },
  {
    id: "mandala-beyond-the-brain",
    ...
    indicaPct: 10,
    sativaPct: 90,
    genetics: "Colombian Sativa / Haze x Satori Elite",
    lineage: "Colombian Sativa / Haze x Satori Elite",
    dominantTerpene: "terpinolene",
    terpenes: { terpinolene: 45, pinene: 25, myrcene: 18, caryophyllene: 12 },
    flavors: ["Zanahoria Silvestre", "Incienso Fino", "Eucalipto", "Pimienta Blanca"],
    effects: ["Claridad Cerebral Trascendente", "Expansión de Consciencia", "Lúcida Agudeza", "Energía Mental"],
    activities: ["meditation", "writing", "philosophy", "creative"],
    description: "Una auténtica joya botánica de Mandala Seeds creada a partir de genéticas colombianas y de Haze de la vieja escuela cruzadas con su línea Satori élite. Beyond the Brain ofrece un colocón diáfano, cristalino y trascendente de una pureza psicológica inigualable, apreciada por pensadores, creativos y meditadores avanzados.",
    image: "img/mandala-beyond-the-brain.webp",
    visualColor: "linear-gradient(135deg, #3B82F6 0%, #10B981 100%)",
    bgPattern: "radial-gradient(circle, rgba(59,130,246,0.2) 0%, transparent 70%)"
  },
  {
    id: "mandala-california-dream",
    ...
    indicaPct: 50,
    sativaPct: 50,
    genetics: "Mexican Sativa x Afghan Indica",
    lineage: "Mexican Sativa x Afghan Indica",
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 35, myrcene: 30, limonene: 20, humulene: 15 },
    flavors: ["Dulce Menta", "Skunk Cítrico", "Caramelo de Fruta", "Toque Terroso"],
    effects: ["Relajación Equilibrada", "Bienestar Alegre", "Alivio Corporal", "Sociabilidad Cómoda"],
    activities: ["social", "chill", "movies", "dinner"],
    description: "Híbrido vigoroso que combina genéticas clásicas mexicanas y afganas seleccionadas en California. Produce colas principales colosales con una estructura densa y compacta, desprendiendo una fragancia dulce a golosinas de menta y skunk afrutado, culminando en un efecto placentero, reconfortante y equilibrado.",
    image: "img/mandala-california-dream.webp",
    visualColor: "linear-gradient(135deg, #F59E0B 0%, #3B82F6 100%)",
    bgPattern: "radial-gradient(circle, rgba(245,158,11,0.2) 0%, transparent 70%)"
  },
  {
    id: "mandala-speed-queen",
    name: "Speed Queen",
    bank: "Mandala Seeds",
    species: "Índica",
    thc: 19,
    ...
    indicaPct: 70,
    sativaPct: 30,
    genetics: "Himachal Pradesh Hashplant x Early Skunk",
    lineage: "Himachal Pradesh Hashplant x Early Skunk",
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 40, caryophyllene: 28, pinene: 18, linalool: 14 },
    flavors: ["Hachís Dulce", "Naranja Confitada", "Tierra Húmeda", "Madera de Cedro"],
    effects: ["Relajación Sedosa", "Paz Interior", "Anti-Estrés", "Calma Muscular"],
    activities: ["relax", "sleep", "gaming", "chill"],
    description: "Creada a partir de un cruce entre una planta de hachís selecta del norte de la India (Himachal Pradesh) y una Early Skunk resistente. Speed Queen es apreciada por su rápida floración de apenas 55 días, su abundante producción de resina de primera calidad para extracción y su sabor a naranja con toques de hachís tradicional especiado.",
    image: "img/mandala-speed-queen.webp",
    visualColor: "linear-gradient(135deg, #EAB308 0%, #8B5CF6 100%)",
    bgPattern: "radial-gradient(circle, rgba(234,179,8,0.2) 0%, transparent 70%)"
  },
  {
    id: "mandala-purple-paro-valley",
    name: "Purple Paro Valley",
    bank: "Mandala Seeds",
    species: "Sativa",
    thc: 18,
    cbd: 0.3,
    ...
    indicaPct: 15,
    sativaPct: 85,
    genetics: "Wild Bhutan Landrace (Paro Valley)",
    lineage: "Wild Bhutan Landrace (Paro Valley)",
    dominantTerpene: "pinene",
    terpenes: { pinene: 40, myrcene: 25, caryophyllene: 20, terpinolene: 15 },
    flavors: ["Pino Silvestre", "Té Negro del Himalaya", "Lima Verde", "Incienso Suave"],
    effects: ["Sensación Medicamentosa Suave", "Claridad Mental Pura", "Antiestrés Ligero", "Sosiego Orgánico"],
    activities: ["nature", "hiking", "meditation", "reading"],
    description: "Variedad silvestre pura landrace procedente de las altas montañas del valle de Paro en Bután occidental (a más de 2500 metros de altitud). Posee una resistencia legendaria al frío, la lluvia y los hongos, exhibiendo cálices púrpuras fascinantes y un perfil de resina aromática a pino fresco, té negro y lima con un efecto claro, suave y medicinal.",
    image: "img/mandala-purple-paro-valley.webp",
    visualColor: "linear-gradient(135deg, #9333EA 0%, #10B981 100%)",
    bgPattern: "radial-gradient(circle, rgba(147,51,234,0.2) 0%, transparent 70%)"
  },
  {
    id: "g13-labs-pineapple-express",
    name: "Pineapple Express",
    bank: "G13 Labs Seeds",
    species: "Sativa",
    thc: 21,
    ...
    indicaPct: 30,
    sativaPct: 70,
    genetics: "Trainwreck x Hawaiian Sativa",
    lineage: "Trainwreck x Hawaiian Sativa",
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 40, limonene: 30, caryophyllene: 20, pinene: 10 },
    flavors: ["Piña Tropical Dulce", "Mango Maduro", "Madera de Cedro", "Cítricos Brillantes"],
    effects: ["Euforia Enérgica", "Creatividad Despierta", "Elevación Mental Positiva", "Relajación Corporal Cálida"],
    activities: ["creative", "social", "gaming", "music"],
    description: "El buque insignia legendario de G13 Labs y una de las cepas más famosas del mundo cannábico. Nacida del cruce entre Trainwreck y una selección de Hawaiian Sativa, produce cogollos densos cubiertos de resina brillante con un aroma embriagador a piña fresca tropical, mango dulce y maderas nobles. Su efecto combina una poderosa euforia cerebral con una placentera relajación física.",
    image: "img/g13-labs-pineapple-express.webp",
    visualColor: "linear-gradient(135deg, #F59E0B 0%, #10B981 100%)",
    bgPattern: "radial-gradient(circle, rgba(245,158,11,0.2) 0%, transparent 70%)"
  },
  {
    ...
    indicaPct: 70,
    sativaPct: 30,
    genetics: "Blueberry x F13 x OG Kush",
    lineage: "(Blueberry x F13) x OG Kush",
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 38, myrcene: 32, limonene: 18, linalool: 12 },
    flavors: ["Arándanos Silvestres", "Combustible OG", "Tierra Húmeda", "Frutos del Bosque"],
    effects: ["Relajación Muscular Intensa", "Paz Mental Serenante", "Bienestar Físico Profundo", "Alivio del Estrés"],
    activities: ["relaxation", "movie", "sleep", "reading"],
    description: "Una obra maestra genética que fusiona tres colosos del sabor y la potencia: Blueberry, F13 y la legendaria OG Kush. Desarrolla flores compactas y cargadas de tricomas bulbosos con reflejos azulados. Su buqué aromático desprende una combinación exquisita de bayas silvestres y el característico fondo terroso a queroseno de la OG Kush.",
    image: "img/g13-labs-blue-og.webp",
    visualColor: "linear-gradient(135deg, #3B82F6 0%, #1E3A8A 100%)",
    bgPattern: "radial-gradient(circle, rgba(59,130,246,0.2) 0%, transparent 70%)"
  },
  {
    id: "g13-labs-c99",
    ...
    indicaPct: 15,
    sativaPct: 85,
    genetics: "Cinderella 99 (Princess x Cinderella 88)",
    lineage: "Princess x Cinderella 88",
    dominantTerpene: "terpinolene",
    terpenes: { terpinolene: 42, myrcene: 26, ocimene: 20, limonene: 12 },
    flavors: ["Pomelo Tropical", "Piña Azucarada", "Incienso Haze Dulce", "Flores Frescas"],
    effects: ["Claridad Mental Cristalina", "Euforia Motivadora", "Estimulación Creativa", "Chispa Social"],
    activities: ["creative", "focus", "hiking", "social"],
    description: "La 'Cinderella 99' o el Santo Grial de las sativas de floración ultrarrápida. Seleccionada por G13 Labs por su rapidez inverosímil (menos de 8 semanas) y su penetrante fragancia a pomelo maduro, piña ácida y flores tropicales. Entrega un colocón cerebral de enorme lucidez, euforia y vitalidad diurna sin pesadez corporal.",
    image: "img/g13-labs-c99.webp",
    visualColor: "linear-gradient(135deg, #EAB308 0%, #EC4899 100%)",
    bgPattern: "radial-gradient(circle, rgba(234,179,8,0.2) 0%, transparent 70%)"
  },
  {
    id: "g13-labs-gigabud",
    ...
    lineage: "Northern Lights x Big Bud",
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 45, pinene: 25, caryophyllene: 20, humulene: 10 },
    flavors: ["Hachís Tradicional", "Uvas Maduras", "Sándalo Afgano", "Tierra Dulce"],
    effects: ["Sedación Corporal Profunda", "Efecto Sofá Calmante", "Sueño Reparador", "Desconexión Total"],
    activities: ["sleep", "relaxation", "movie", "meditation"],
    description: "Un peso pesado indiscutible nacido del mítico matrimonio entre Northern Light y Big Bud. Produce colas masivas y monolíticas de cogollos rocosos saturados de glándulas de resina. Su aroma es el clásico del hachís dulce de la vieja escuela con toques afrutados de uva madura y madera noble, provocando una sedación corporal rotunda y placentera.",
    image: "img/g13-labs-gigabud.webp",
    visualColor: "linear-gradient(135deg, #10B981 0%, #064E3B 100%)",
    bgPattern: "radial-gradient(circle, rgba(16,185,129,0.2) 0%, transparent 70%)"
  },
  {
    id: "g13-labs-raw-diesel",
    name: "Raw Diesel",
    bank: "G13 Labs Seeds",
    species: "Hibrido",
    thc: 21,
    ...
    indicaPct: 35,
    sativaPct: 65,
    genetics: "NYC Diesel x G13",
    lineage: "(Mexican Sativa x Afghani) x G13",
    dominantTerpene: "limonene",
    terpenes: { limonene: 40, myrcene: 28, caryophyllene: 22, pinene: 10 },
    flavors: ["Gasolina Diésel Pura", "Mandarina Ácida", "Pomelo Amargo", "Pimienta Picante"],
    effects: ["Subidón Cerebral Eléctrico", "Enfoque Dinámico", "Vitalidad Activa", "Desahogo Mental"],
    activities: ["social", "gaming", "creative", "party"],
    description: "Cruce magistral entre la aromática NYC Diesel y el legendario clon de investigación G13. Destaca por un perfil terpénico penetrante y electrizante que mezcla vapores de combustible diésel crudo con notas cítricas punzantes de mandarina amarga y pomelo. Despierta la mente con un torrente de euforia activa y entusiasmo expansivo.",
    image: "img/g13-labs-raw-diesel.webp",
    visualColor: "linear-gradient(135deg, #EF4444 0%, #F59E0B 100%)",
    bgPattern: "radial-gradient(circle, rgba(239,68,68,0.2) 0%, transparent 70%)"
  },
  {
    id: "g13-labs-double-black",
    name: "Double Black",
    bank: "G13 Labs Seeds",
    species: "Indica",
    thc: 20,
    ...
    indicaPct: 100,
    sativaPct: 0,
    genetics: "Black Domina 98 Selection",
    lineage: "Black Domina '98 inbred selection",
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 42, caryophyllene: 30, humulene: 18, pinene: 10 },
    flavors: ["Hachís Negro Intenso", "Café Tostado", "Pimienta Negra", "Madera Antigua"],
    effects: ["Efecto Narcótico Pleno", "Pesadez Física Placentera", "Paz Interior Absoluta", "Alivio del Insomnio"],
    activities: ["sleep", "relaxation", "meditation"],
    description: "Una índica pura de élite lograda mediante retrocruce y estabilización meticulosa de la célebre Black Domina '98. Presenta hojas anchas verde oscuro casi negro y cogollos resinosos densos con aroma a hachís charas, café torrefacto y especias afganas oscuras. Su efecto es un bálsamo físico sedante de nivel terapéutico ideal para el final del día.",
    image: "img/g13-labs-double-black.webp",
    visualColor: "linear-gradient(135deg, #18181B 0%, #6B21A8 100%)",
    bgPattern: "radial-gradient(circle, rgba(107,33,168,0.2) 0%, transparent 70%)"
  },
  {
    id: "g13-labs-white-lavender",
    name: "White Lavender",
    bank: "G13 Labs Seeds",
    species: "Hibrido",
    thc: 20,
    ...
    lineage: "White Widow x Lavender",
    dominantTerpene: "linalool",
    terpenes: { linalool: 40, caryophyllene: 28, myrcene: 20, terpinolene: 12 },
    flavors: ["Lavanda Provenzal", "Especias Frescas", "Vainilla Almizclada", "Flores Silvestres"],
    effects: ["Serenidad Lúcida", "Armonía Sensorial", "Equilibrio Cuerpo-Mente", "Sensación Antiansiedad"],
    activities: ["meditation", "reading", "relaxation", "nature"],
    description: "La suntuosa unión entre la escarchada White Widow y la fragante Lavender de Soma. El resultado es una planta de belleza aristocrática con flores nevadas en resina aromática que desprenden un perfume cautivador a flores de lavanda silvestre, hierbas dulces y vainilla especiada. Proporciona una experiencia armónica y apacible que disuelve la ansiedad cotidiana.",
    image: "img/g13-labs-white-lavender.webp",
    visualColor: "linear-gradient(135deg, #8B5CF6 0%, #EC4899 100%)",
    bgPattern: "radial-gradient(circle, rgba(139,92,246,0.2) 0%, transparent 70%)"
  },
  {
    id: "g13-labs-midnight-kush",
    name: "Midnight Kush",
    bank: "G13 Labs Seeds",
    species: "Indica",
    thc: 20,
    ...
    indicaPct: 75,
    sativaPct: 25,
    genetics: "Hash Plant x Blueberry",
    lineage: "Hash Plant x Blueberry",
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 44, pinene: 26, caryophyllene: 20, linalool: 10 },
    flavors: ["Arándanos Azucarados", "Pino Fresco de Montaña", "Hachís Dulce", "Tierra Fresca"],
    effects: ["Calma Nocturna", "Relajación Muscular Sedosa", "Tranquilidad Mental", "Apetito Agradable"],
    activities: ["movie", "relaxation", "sleep", "food"],
    description: "Cruce sublime entre una prolífica Hash Plant afgana y la dulce Blueberry. En floración avanzada despliega cálices teñidos de púrpura medianoche con una capa exuberante de resina escarchada. Su fragancia combina arándanos maduros con el frescor del pino nórdico y fondo terroso de hachís fino, sumergiendo al usuario en una placentera calma nocturna.",
    image: "img/g13-labs-midnight-kush.webp",
    visualColor: "linear-gradient(135deg, #4C1D95 0%, #2563EB 100%)",
    bgPattern: "radial-gradient(circle, rgba(76,29,149,0.2) 0%, transparent 70%)"
  },
  {
    id: "g13-labs-blueberry-gum",
    name: "Blueberry Gum",
    bank: "G13 Labs Seeds",
    species: "Indica",
    thc: 20,
    ...
    lineage: "Blueberry x Bubble Gum",
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 38, limonene: 30, caryophyllene: 20, ocimene: 12 },
    flavors: ["Chicle de Arándanos", "Golosina de Fresa", "Baya Silvestre Dulce", "Azúcar Glas"],
    effects: ["Euforia Sonriente", "Relajación Física Suave", "Alegría Despreocupada", "Buen Humor"],
    activities: ["social", "music", "gaming", "relaxation"],
    description: "Un auténtico deleite para los amantes de los sabores golosos y azucarados. Cruce directo entre la mítica Blueberry y la histórica Bubble Gum. Sus flores exhalan un aroma irresistible a chicle masticable de frutos del bosque con notas de fresa y arándano dulce. Ofrece una relajación física muy confortable acompañada de una euforia risueña y distendida.",
    image: "img/g13-labs-blueberry-gum.webp",
    visualColor: "linear-gradient(135deg, #EC4899 0%, #3B82F6 100%)",
    bgPattern: "radial-gradient(circle, rgba(236,72,153,0.2) 0%, transparent 70%)"
  },
  {
    id: "g13-labs-chocolate-heaven",
    ...
    indicaPct: 20,
    sativaPct: 80,
    genetics: "Cannalope Haze x Afghan",
    lineage: "Cannalope Haze x Afghani",
    dominantTerpene: "terpinolene",
    terpenes: { terpinolene: 40, myrcene: 28, humulene: 18, limonene: 14 },
    flavors: ["Cacao Tostado", "Melón Cantalupo", "Haze Especiado", "Toque de Chocolate Negro"],
    effects: ["Inspiración Mental", "Energía Cálida", "Estimulación Creativa", "Optimismo Radiante"],
    activities: ["creative", "focus", "music", "hiking"],
    description: "Una sativa exótica y vigorosa producto del cruce entre la afrutada Cannalope Haze y una robusta Afghani. Sus colas alargadas y brillantes emanan un aroma singular que evoca notas de cacao negro tostado, melón dulce de verano y el carácter especiado de los inciensos Haze. Genera un estado anímico luminoso, creativo y radiante.",
    image: "img/g13-labs-chocolate-heaven.webp",
    visualColor: "linear-gradient(135deg, #78350F 0%, #F59E0B 100%)",
    bgPattern: "radial-gradient(circle, rgba(120,53,15,0.2) 0%, transparent 70%)"
  }
  ,
  {
    ...
    indicaPct: 100,
    sativaPct: 0,
    genetics: "Hindu Kush Landrace (Norte de Afganistán)",
    lineage: "Landrace afgana pura de los valles del río Amu Daria",
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 48, caryophyllene: 28, pinene: 24 },
    flavors: ["Hachís Afgano", "Madera Noble", "Tierra Especiada", "Sándalo"],
    effects: ["Relajación Muscular Profunda", "Efecto Narcótico Fuerte", "Sedación Placentera", "Paz Corporal"],
    activities: ["relax_sleep", "pain_relief", "meditation"],
    description: "Variedad 100% Índica pura originaria de los valles del río Amu Daria en el norte de Afganistán. Famosa mundialmente por su inmensa producción de resina de tricomas glandulares, aroma penetrante a hachís charas milenario y una relajación física contundente y narcótica.",
    image: "img/wos-afghan-kush.webp",
    visualColor: "linear-gradient(135deg, #10B981 0%, #064E3B 100%)",
    bgPattern: "radial-gradient(circle, rgba(16,185,129,0.2) 0%, transparent 70%)"
  },
  {
    id: "wos-pakistan-valley",
    name: "Pakistan Valley",
    bank: "World of Seeds",
    species: "Indica",
    thc: 21.2,
    cbd: 0.9,
    ...
    indicaPct: 100,
    sativaPct: 0,
    genetics: "Northern Pakistan Hindu Kush Landrace",
    lineage: "Landrace paquistaní pura de los valles montañosos del Hindu Kush",
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 45, caryophyllene: 30, humulene: 25 },
    flavors: ["Hachís Dulce", "Tierra Húmeda", "Frutos Secos", "Pino Suave"],
    effects: ["Calma Corporal Inmediata", "Sedación Nocturna", "Paz Mental", "Alivio Físico"],
    activities: ["relax_sleep", "pain_relief", "evening"],
    description: "Índica pura autóctona del norte de Pakistán. Destaca por su robustez, estructura compacta y una rapidez de floración de apenas 45-55 días. Produce flores prietas recubiertas de tricomas con un aroma dulce terroso y un efecto profundamente sedante y medicinal.",
    image: "img/wos-pakistan-valley.webp",
    visualColor: "linear-gradient(135deg, #059669 0%, #064E3B 100%)",
    bgPattern: "radial-gradient(circle, rgba(5,150,105,0.2) 0%, transparent 70%)"
  },
  {
    ...
    indicaPct: 100,
    sativaPct: 0,
    genetics: "Moroccan Rif Mountains Landrace (Chefchaouen / Ketama)",
    lineage: "Landrace 100% marroquí del valle de Ketama aclimatada a suelos áridos",
    dominantTerpene: "caryophyllene",
    terpenes: { caryophyllene: 42, myrcene: 33, pinene: 25 },
    flavors: ["Kif Marroquí", "Madera de Cedro", "Hierbas Áridas", "Especias del Desierto"],
    effects: ["Paz Meditativa", "Relajación Corporal Serena", "Claridad Tranquila", "Bienestar Ligero"],
    activities: ["meditation", "relax_sleep", "afternoon"],
    description: "Auténtica genética tradicional del Rif marroquí, cuna del mejor hachís del Mediterráneo. Extremadamente resistente a la sequía y plagas, florece con rapidez produciendo un bouquet inconfundible a madera noble, resina aromática y especias saharianas con un efecto contemplativo.",
    image: "img/wos-ketama.webp",
    visualColor: "linear-gradient(135deg, #D97706 0%, #78350F 100%)",
    bgPattern: "radial-gradient(circle, rgba(217,119,6,0.2) 0%, transparent 70%)"
  },
  {
    id: "wos-colombian-gold",
    name: "Colombian Gold",
    bank: "World of Seeds",
    species: "Sativa",
    thc: 19.3,
    ...
    indicaPct: 0,
    sativaPct: 100,
    genetics: "Sierra Nevada de Santa Marta Landrace",
    lineage: "Sativa pura legendaria de las montañas tropicales colombianas",
    dominantTerpene: "limonene",
    terpenes: { limonene: 46, terpinolene: 32, pinene: 22 },
    flavors: ["Cítrico Tropical", "Fruta Madura Dulce", "Notas Florales", "Mango Silvestre"],
    effects: ["Euforia Eléctrica", "Creatividad Psicoactiva", "Alegría Contagiosa", "Vibración Lúcida"],
    activities: ["creativity", "social", "music_listening"],
    description: "La reina dorada de las sativas colombianas de los años 70. Nacida en la Sierra Nevada de Santa Marta, desarrolla colas largas y brillantes con cálices dorados. Su aroma es intensamente cítrico y dulce, detonando una estimulación mental lúcida, energizante y sumamente eufórica.",
    image: "img/wos-colombian-gold.webp",
    visualColor: "linear-gradient(135deg, #F59E0B 0%, #B45309 100%)",
    bgPattern: "radial-gradient(circle, rgba(245,158,11,0.2) 0%, transparent 70%)"
  },
  {
    id: "wos-wild-thailand",
    name: "Wild Thailand",
    bank: "World of Seeds",
    species: "Sativa",
    thc: 22.3,
    ...
    indicaPct: 0,
    sativaPct: 100,
    genetics: "Ko Chang Archipelago Thai Landrace",
    lineage: "Sativa pura tailandesa autóctona del archipiélago de Ko Chang",
    dominantTerpene: "terpinolene",
    terpenes: { terpinolene: 50, myrcene: 28, limonene: 22 },
    flavors: ["Cítrico Especiado", "Hierba Limón", "Incienso Oriental", "Jengibre"],
    effects: ["Subidón Cerebral Explosivo", "Euforia Psicodélica", "Motivación Activa", "Claridad Luminosa"],
    activities: ["nature_walk", "creativity", "active_day"],
    description: "Pura sativa del sudeste asiático recolectada en las islas de Ko Chang. Una de las variedades más potentes de Tailandia, con cogollos repletos de resina cítrica y fresca. Produce un efecto cerebral rápido, expansivo y altamente estimulante sin pesadez física.",
    image: "img/wos-wild-thailand.webp",
    visualColor: "linear-gradient(135deg, #84CC16 0%, #4D7C0F 100%)",
    bgPattern: "radial-gradient(circle, rgba(132,204,22,0.2) 0%, transparent 70%)"
  },
  {
    id: "wos-south-african-kwazulu",
    name: "South African Kwazulu",
    bank: "World of Seeds",
    species: "Sativa",
    thc: 19.8,
    cbd: 0.4,
    ...
    indicaPct: 0,
    sativaPct: 100,
    genetics: "Drakensberg Mountains South African Landrace",
    lineage: "Sativa pura salvaje sudafricana de las estribaciones de Drakensberg",
    dominantTerpene: "pinene",
    terpenes: { pinene: 44, terpinolene: 34, caryophyllene: 22 },
    flavors: ["Especias Dulces", "Pino Fresco", "Anís Silvestre", "Pimienta Suave"],
    effects: ["Energía Focalizada", "Claridad Mental Lúcida", "Subidón Estimulante", "Dinamismo"],
    activities: ["sports_active", "social", "outdoor"],
    description: "Sativa salvaje sudafricana utilizada ancestralmente por los guerreros zulúes antes de la batalla. Sorprende por su floración rápida para ser sativa pura (60 días). Aroma especiado y anisado con un efecto vivaz, dinámico y muy energizante.",
    image: "img/wos-south-african-kwazulu.webp",
    visualColor: "linear-gradient(135deg, #EAB308 0%, #A16207 100%)",
    bgPattern: "radial-gradient(circle, rgba(234,179,8,0.2) 0%, transparent 70%)"
  },
  {
    id: "wos-brazil-amazonia",
    ...
    indicaPct: 25,
    sativaPct: 75,
    genetics: "Amazon Rainforest Brazilian Landrace",
    lineage: "Genética nativa recolectada en lo profundo de la selva del Amazonas",
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 40, limonene: 35, ocimene: 25 },
    flavors: ["Fruta Tropical Agridulce", "Papaya Silvestre", "Madera Selvática", "Maracuyá"],
    effects: ["Euforia Festiva", "Relajación Corporal Ondulante", "Sensación de Bienestar", "Optimismo"],
    activities: ["social", "music_listening", "creative_projects"],
    description: "Variedad silvestre nacida en la selva tropical del Amazonas. Desarrolla cogollos exuberantes y compactos con un perfil de terpenos tropical único que recuerda a frutas selváticas exóticas. Efecto inicialmente eufórico y alegre que evoluciona hacia una suave tranquilidad física.",
    image: "img/wos-brazil-amazonia.webp",
    visualColor: "linear-gradient(135deg, #10B981 0%, #047857 100%)",
    bgPattern: "radial-gradient(circle, rgba(16,185,129,0.2) 0%, transparent 70%)"
  },
  {
    ...
    indicaPct: 0,
    sativaPct: 100,
    genetics: "Mount Kilimanjaro Kenyan Landrace",
    lineage: "Sativa pura autóctona de las laderas del monte Kilimanjaro",
    dominantTerpene: "terpinolene",
    terpenes: { terpinolene: 45, pinene: 30, myrcene: 25 },
    flavors: ["Cítrico Especiado", "Incienso Africano", "Hierbas de Sabana", "Toque Picante"],
    effects: ["Energía Contundente", "Vigor Físico y Mental", "Euforia Despierta", "Vitalidad Activa"],
    activities: ["outdoor", "gaming", "nature_walk"],
    description: "Apodada 'rompe-elefantes' por los nativos de las laderas del Kilimanjaro. Sativa pura africana adaptada a la alta montaña que produce una resina de aroma cítrico y especiado sumamente penetrante, con un efecto vigoroso, electrizante y de gran resistencia física.",
    image: "img/wos-kilimanjaro.webp",
    visualColor: "linear-gradient(135deg, #F97316 0%, #C2410C 100%)",
    bgPattern: "radial-gradient(circle, rgba(249,115,22,0.2) 0%, transparent 70%)"
  },
  {
    id: "wos-northern-light-x-bigbud",
    name: "Northern Light x Big Bud",
    bank: "World of Seeds",
    species: "Indica",
    thc: 22.0,
    cbd: 1.4,
    ...
    sativaPct: 0,
    genetics: "Northern Light x Big Bud",
    lineage: "Híbrido de dos leyendas productoras y medicinales de los años 80",
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 50, caryophyllene: 28, pinene: 22 },
    flavors: ["Hachís Dulce", "Pino Especiado", "Cítrico Almibarado", "Tierra Fértil"],
    effects: ["Relajación Muscular Extrema", "Alivio del Dolor", "Sueño Reparador", "Paz Total"],
    activities: ["relax_sleep", "pain_relief", "evening"],
    description: "Cruce maestro entre dos iconos del cannabis: la potencia resinosa de Northern Light y los cálices gigantescos de Big Bud. Produce cosechas colosales de cogollos monumentales repletos de resina medicinal con aroma dulce terroso y un efecto sedante de primer nivel.",
    image: "img/wos-northern-light-x-bigbud.webp",
    visualColor: "linear-gradient(135deg, #10B981 0%, #064E3B 100%)",
    bgPattern: "radial-gradient(circle, rgba(16,185,129,0.25) 0%, transparent 70%)"
  },
  {
    id: "wos-strawberry-blue",
    ...
    indicaPct: 25,
    sativaPct: 75,
    genetics: "Pure Strawberry x New Blue Line",
    lineage: "Selección dulce de fresa silvestre cruzada con la línea Blueberry",
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 42, limonene: 36, caryophyllene: 22 },
    flavors: ["Fresas Silvestres", "Arándanos Dulces", "Flores Frescas", "Caramelo de Fresa"],
    effects: ["Euforia Radiante", "Relajación Agradable", "Creatividad Inspirada", "Bienestar Social"],
    activities: ["creativity", "social", "cooking"],
    description: "Híbrido sativa seleccionado por su explosivo bouquet a golosina de fresa silvestre y frutas del bosque. Desarrolla flores esponjosas y resinosas con pistilos de colores vivos. Su efecto es chispeante, divertido y reconfortante, ideal para disfrutar en buena compañía.",
    image: "img/wos-strawberry-blue.webp",
    visualColor: "linear-gradient(135deg, #EC4899 0%, #8B5CF6 100%)",
    bgPattern: "radial-gradient(circle, rgba(236,72,153,0.2) 0%, transparent 70%)"
  }
