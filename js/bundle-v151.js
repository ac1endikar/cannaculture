...
// ═══════════════════════════════════════════════════════════════════════════
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    id: "samsara-golden-tiger",
    image: "img/samsara-golden-tiger.webp",
    name: "Golden Tiger",
    aka: "Malawi x Meao Thai",
    bank: "Samsara Seeds",
    species: "Sativa",
    thc: 22, cbd: 0.2,
    yieldIndoor: 400, yieldOutdoor: 700,
    floweringDays: 90, rating: 4.9, reviewsCount: 430,
    genetics: "Malawi x Meao Thai",
    origin: "España",
    dominantTerpene: "terpinolene",
    terpenes: { terpinolene: 50, limonene: 30, pinene: 20 },
    flavors: ["Miel Dorada", "Especias Asiáticas", "Floral Exótico"],
    effects: ["Viaje Cerebral Profundo", "Expansión Mental", "Energía Sativa Pura"],
    activities: ["creativity", "nature_walk"],
    description: "Golden Tiger es considerada por muchos coleccionistas una de las sativas más extraordinarias del mundo. Cruce de dos landrace asiáticas de élite —Malawi y Meao Thai— que produce porras sativas monumentales con un aroma a especias orientales, miel y flores exóticas. El efecto es una experiencia cerebral transformadora.",
    visualColor: "linear-gradient(135deg, #2c1810 0%, #8b4513 50%, #d4af37 100%)",
    bgPattern: "radial-gradient(circle, rgba(212,175,55,0.2) 0%, transparent 70%)"
  },
  {
  ...
  },
  {
    ...
    image: "img/dp-think-different.webp",
    name: "Think Different",
    aka: "AK420 Auto x Ruderalis",
    bank: "Dutch Passion",
    species: "Sativa",
    thc: 21, cbd: 0.3,
    yieldIndoor: 600, yieldOutdoor: 700,
    floweringDays: 70, rating: 4.8, reviewsCount: 980,
    genetics: "AK420 x Ruderalis",
    origin: "Países Bajos",
    dominantTerpene: "limonene",
    terpenes: { limonene: 45, terpinolene: 35, caryophyllene: 20 },
    flavors: ["Skunk Clásico", "Cítrico Suave", "Tierra Autoflor"],
    effects: ["Euforia Autoflor", "Energía", "Bienestar Rápido"],
    activities: ["creativity", "social"],
    description: "Think Different es la autoflor flagship de Dutch Passion, que rompió todos los prejuicios sobre las autoflowers con potencias cercanas al 21% THC y rendimientos de hasta 600g/m². Ciclo ultrarrápido de semilla a cosecha en 70-75 días con una calidad comparable a las mejores fotoperiódicas del mercado.",
    visualColor: "linear-gradient(135deg, #003366 0%, #0066cc 50%, #3399ff 100%)",
    bgPattern: "radial-gradient(circle, rgba(0,102,204,0.2) 0%, transparent 70%)"
  },
  {
    id: "dp-glueberry-og",
  ...
  {
    id: "delicious-auto-pounder",
    image: "img/delicious-auto-pounder.webp",
    name: "Auto Pounder",
    aka: "Critical x Ruderalis",
    bank: "Delicious Seeds",
    species: "Indica",
    thc: 18, cbd: 0.5,
    yieldIndoor: 700, yieldOutdoor: 800,
    floweringDays: 75, rating: 4.7, reviewsCount: 560,
    genetics: "Critical x Ruderalis",
    origin: "España",
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 50, caryophyllene: 30, limonene: 20 },
    flavors: ["Tierra Dulce", "Crítica Herbal", "Suave Skunk"],
    effects: ["Relajación Completa", "Bienestar Corporal", "Calma"],
    activities: ["relax_sleep", "gaming"],
    description: "Auto Pounder es la autoflor más productiva de Delicious Seeds, capaz de producir más de 700g/m² en interior con sus cogollos masivos. Basada en Critical, produce plantas con cogollos tan grandes y pesados que necesitan tutoreado. Perfil aroma suave y efecto relajante típico índica, ideal para usuarios de medicinal.",
    visualColor: "linear-gradient(135deg, #1a2d00 0%, #3a6300 50%, #6b9900 100%)",
    bgPattern: "radial-gradient(circle, rgba(107,153,0,0.2) 0%, transparent 70%)"
  },
  {
  ...
  {
    id: "mrnice-the-church",
    image: "img/mrnice-the-church.webp",
    name: "The Church",
    aka: "Swiss Sativa x NL#5 x Haze x S.Indian",
    bank: "Mr. Nice Seedbank",
    species: "Híbrida",
    thc: 20, cbd: 0.3,
    yieldIndoor: 600, yieldOutdoor: 900,
    floweringDays: 63, rating: 4.7, reviewsCount: 490,
    genetics: "Swiss Sativa x NL#5 x Haze x South Indian",
    origin: "Países Bajos / Australia",
    dominantTerpene: "terpinolene",
    terpenes: { terpinolene: 45, limonene: 30, myrcene: 25 },
    flavors: ["Sativa Suiza", "Haze Dulce", "Herbal Fino"],
    effects: ["Euforia Elevada", "Energía Social", "Bienestar"],
    activities: ["social", "creativity", "nature_walk"],
    description: "The Church es una de las más solicitadas del catálogo de Mr. Nice por su combinación de cuatro líneas legendarias. La Swiss Sativa aporta la energía alpina, NL#5 la producción índica, Haze la complejidad cerebral y South Indian el sabor. El resultado es una variedad muy productiva con efecto eufórico y equilibrado.",
    visualColor: "linear-gradient(135deg, #1a1a3d 0%, #3d3d8a 50%, #8080d4 100%)",
    bgPattern: "radial-gradient(circle, rgba(61,61,138,0.2) 0%, transparent 70%)"
  },
  {
    id: "mrnice-laughing-buddha",
    image: "img/mrnice-laughing-buddha.webp",
    name: "Laughing Buddha",
    aka: "Thai x Jamaican",
    bank: "Mr. Nice Seedbank",
    species: "Sativa",
    thc: 21, cbd: 0.2,
    yieldIndoor: 400, yieldOutdoor: 700,
    floweringDays: 80, rating: 4.8, reviewsCount: 510,
    genetics: "Thai Sativa x Jamaican Sativa",
    origin: "Países Bajos / Australia",
    dominantTerpene: "terpinolene",
    terpenes: { terpinolene: 50, limonene: 30, pinene: 20 },
    flavors: ["Tropical Dulce", "Frutas Jamaicanas", "Especias Thai"],
    effects: ["Risa Contagiosa", "Euforia Alegre", "Energía Social"],
    activities: ["social", "creativity", "nature_walk"],
    description: "Laughing Buddha vive completamente a la altura de su nombre. Este cruce entre Thai y Jamaican es la sativa más alegre y eufórica del catálogo de Mr. Nice Seedbank. La risa contagiosa y la euforia tropical que produce hacen de esta variedad una experiencia social incomparable. Ganadora de la Cannabis Cup.",
    visualColor: "linear-gradient(135deg, #1a3300 0%, #ffd700 50%, #ff8c00 100%)",
  ...
  {
    id: "philo-auto-sugar-candy",
    image: "img/philo-auto-sugar-candy.webp",
    name: "Auto Sugar Candy",
    aka: "Sugar Candy x Ruderalis",
    bank: "Philosopher Seeds",
    species: "Indica",
    thc: 20, cbd: 0.4,
    yieldIndoor: 500, yieldOutdoor: 600,
    floweringDays: 75, rating: 4.7, reviewsCount: 490,
    genetics: "Sugar Candy x Ruderalis",
    origin: "España",
    dominantTerpene: "myrcene",
    terpenes: { myrcene: 45, limonene: 35, linalool: 20 },
    flavors: ["Caramelo Auto", "Dulce Frutal", "Mango Suave"],
    effects: ["Relajación Rápida", "Bienestar", "Calma Anímica"],
    activities: ["relax_sleep", "social"],
    description: "Auto Sugar Candy lleva toda la dulzura de la Sugar Candy original al formato autoflor. Philosopher Seeds logró mantener el extraordinario perfil aromático a caramelo de mango en un ciclo rápido de 75 días. Perfecta para balcones y jardines donde el espacio y el tiempo son factores clave.",
    visualColor: "linear-gradient(135deg, #4a1a00 0%, #aa4a00 50%, #ff9944 100%)",
    bgPattern: "radial-gradient(circle, rgba(170,74,0,0.2) 0%, transparent 70%)"
  },
  {
  ...
  {
    id: "philo-ace-of-spades",
    image: "img/philo-ace-of-spades.webp",
    name: "Ace of Spades",
    aka: "Jack the Ripper x Black Cherry Soda",
    bank: "Philosopher Seeds",
    species: "Híbrida",
    thc: 21, cbd: 0.3,
    yieldIndoor: 480, yieldOutdoor: 650,
    floweringDays: 63, rating: 4.8, reviewsCount: 470,
    genetics: "Jack the Ripper x Black Cherry Soda",
    origin: "España",
    dominantTerpene: "terpinolene",
    terpenes: { terpinolene: 40, limonene: 35, caryophyllene: 25 },
    flavors: ["Cereza Oscura", "Limón Especiado", "Frutal Complejo"],
    effects: ["Euforia Creativa", "Energía Mental", "Bienestar Social"],
    activities: ["creativity", "social", "nature_walk"],
    description: "Ace of Spades es la carta más sofisticada del mazo de Philosopher Seeds. El cruce entre Jack the Ripper y Black Cherry Soda produce cogollos oscuros con tonos morados y negros espectaculares y un aroma a cereza oscura con toque limón y especias. Efecto muy creativo y eufórico, ideal para proyectos artísticos.",
    visualColor: "linear-gradient(135deg, #1a0020 0%, #4a0060 50%, #9a00cc 100%)",
    bgPattern: "radial-gradient(circle, rgba(74,0,96,0.25) 0%, transparent 70%)"
  },
  {
